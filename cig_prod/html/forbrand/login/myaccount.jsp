...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td WIDTH="200" valign="top" align="center"> <img src="../../images/qianqiu.jpg" width="100" height="149"></td>
    <form name="form3" action="welcome.jsp" method="post">
      <td> 
        <p class="contact">If you are already a registered member, please log 
          in below. </p>
        <p><span class="legal-notice">USER NAME:<br>
          </span> 
        ...
        <p class="contact">Forgotten your password? <a href="passwdrecover.jsp">click 
          here</a>. We will send it to you. </p>
        <p class="contact"> If you are not a registered membe, <a href="../../html/benifits.html">click 
          here to see our member benifits</a>, <a href="regform.jsp">click 
          here to regist</a>. </p>
      </td>
    </form>
  </tr>
