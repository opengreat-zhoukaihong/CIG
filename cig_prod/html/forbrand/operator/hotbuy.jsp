    ...
    <td valign="middle"> 
      ...
      <table width="80%" align="center">
        <tr class="black-m-text"> 
          <td class="bottom-menu" colspan="3" > <% if(request.getParameter("stype1")!=null)
  { %> 
            <div align="center"><jsp:useBean id="hotbuy" scope="page" class="com.forbrand.member.hotBuyBean" /> 
              <jsp:setProperty name="hotbuy" property="*" /> <%! String stype1,stype2; %> 
