...
function PostForm(I)
{
  if ( I ==3)
  {
    ...
    wStr = wStr + "'-1'";
    fmOpen.method="post";
    fmOpen.action = "/cnhotel/servlet/com.dreamerland.cnhotelbooking.bst.CbstDelRow?TableName=Room_Type&ID=" + wStr;
    fmOpen.submit();
  }
  else if ( I == 1)
  {
            ...
            <form name=fmOpen  action="">
              ...
              <table width="400" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#FFFFFF">
                <tr align="center"> 
                  ...
                  <td class="font9" width="59">客房类别</td>
                  <td class="font9" colspan="3">说明</td>
                </tr>
<jsp:include page="/servlet/com.dreamerland.cnhotelbooking.bst.CbstOpenRoomType" flush="true" />              </table>
            </form>
          </td>
        </tr>
      </table>
