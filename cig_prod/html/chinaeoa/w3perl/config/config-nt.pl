...
$struct_logfile = "%date %hour %host %login %method %page %query %status %null 
%requetesize %null %agent %referer";
...
# %day          [00-31]
# %prefixlog is in
$struct_compressed_logfile = "%prefixlog%smallyear%month%day.log";
...
### Date format for IIS 3.0 logfile (only)
# Fields allowed : 
# %year [xx]
# %month [00-12]
# %day [00-31]
...
$FLY = "C:/Inetpub/wwwroot/cgi-bin/fly.exe";
...
$emailadr = "webmaster\@w3perl.com"; # your email here (default is webmaster's email)
