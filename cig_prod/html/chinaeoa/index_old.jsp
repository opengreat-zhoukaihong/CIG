        ...
        <tr> 
          <td> 
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td colspan="3"><img src="/images/temp/body_up.gif" width="443" height="146" border="0" usemap="#Map"><map name="Map"><area shape="circle" coords="257,50,26" href="ProductSearch.jsp?TypeId=3&amp;LangCode=GB" onMouseOver="ShowLayer(1)" alt="复印机" title="复印机"><area shape="circle" coords="197,57,23" href="ProductSearch.jsp?TypeId=1&amp;LangCode=GB" onMouseOver="ShowLayer(2)" alt="打印机" title="打印机"><area shape="circle" coords="141,76,25" href="ProductSearch.jsp?TypeId=2&amp;LangCode=GB" onMouseOver="ShowLayer(3)" alt="传真机" title="传真机"><area shape="circle" coords="101,115,25" onMouseOver="ShowLayer(4)" href="ProductSearch.jsp?TypeId=8&amp;LangCode=GB" alt="扫描仪" title="扫描仪"><area shape="circle" coords="68,153,27" href="ProductSearch.jsp?TypeId=4&amp;LangCode=GB" onMouseOver="ShowLayer(5)" alt="耗材" title="耗材"></map></td>
              </tr>
              <tr> 
                <td width="270"><img src="/images/temp/body_m1.gif" width="270" height="72" border="0" usemap="#Map2"><map name="Map2"><area shape="circle" coords="49,56,24" href="ProductSearch.jsp?TypeId=5&amp;LangCode=GB" onMouseOver="ShowLayer(6)" alt="零件" title="零件"><area shape="circle" coords="65,5,22" href="ProductSearch.jsp?TypeId=4&amp;LangCode=GB" onMouseOver="ShowLayer(5)" alt="耗材" title="耗材"></map></td>
                <td width="124">
