        ...
        <tr>
          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="rpass" method="post" action="rpass2.jsp" onSubmit="return validateForm(rpass)">
                <tr bgcolor="#F4FCFF"> 
                  <td height="30" colspan="2" align="center"><font color="#CC0000">忘记了密码,没关系.我们替您修.请输入您的用户名</font></td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#DFEEFF" width="140">用 户 名：</td>
                  <td bgcolor="#DFEEFF" width="348"> 
                    <input type="text" name="userID" size="15" class="font1">
                  </td>
                </tr>
                <tr> 
                  <td bgcolor="#F4FCFF" colspan="2">&nbsp;&nbsp; &nbsp;&nbsp; 
                  </td>
                </tr>
                <tr> 
