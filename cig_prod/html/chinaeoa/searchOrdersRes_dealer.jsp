...
if (a[i].indexOf("#")!=0){ d.MM_p[j]=new Image; d.MM_p[j++].src=a[i];}}
  ...
  function processOrder(tempOrderID)
  {
    ...
    document.fmProcessOrder.action = "processOrder_dealer.jsp";
  ...
  function orderDetail(tempOrderID,tempSellerID)
  {
    ...
    document.fmSubOrder.sellerID.value = tempSellerID;
  ...
  {
    document.fmProcessOrder.orderID.value = tempOrderID;
    document.fmProcessOrder.action = "orderContent_dealer.jsp";
    document.fmProcessOrder.submit();
  }
...
<%!
  ...
  String status,sellerName,orderDateBgn,orderDateEnd,searchOrderID,buyerID;
  String statusName;
...
<%
  ...
  sellerName = request.getParameter("name");
...
<FORM NAME="browseList" action="searchOrdersRes_dealer.jsp" METHOD="post" >
...
<%                 if(status.equals("5"))  {
%>                    <td><a href="javascript:processOrder('<%=myOrder.getOrderID()%>')">处理订单</a></td>
                <% }   %>
