          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              ...
              <form name="newShip" method="post" action="addShipResult.jsp" onSubmit="return validateForm(newShip)">
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#DFEEFF" width="137">国&nbsp;&nbsp;&nbsp;&nbsp;家：</td>
           ...
           <%  }   %>
                ...
                <tr> 
                  <td align="right" bgcolor="#F4FCFF" width="137">省&nbsp;&nbsp;&nbsp;&nbsp;份：</td>
                ...
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" width="137">城&nbsp;&nbsp;&nbsp;&nbsp;市：</td>
                  <td bgcolor="#DFEEFF" width="351"> 
                ...
                <tr>
                  <td align="right" bgcolor="#F4FCFF" width="137">收货方名称：</td>
                  <td bgcolor="#F4FCFF" width="351"> 
                    <input type="text" name="shipName" size="35" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" width="137">收货方地址：</td>
                  <td bgcolor="#DFEEFF" width="351"> 
                ...
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#F4FCFF" width="137">邮&nbsp;&nbsp;&nbsp;&nbsp;编：</td>
                  <td bgcolor="#F4FCFF" width="351"> 
                    <input type="text" name="zipCode" size="20" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" width="137">联 系 人：</td>
                  <td bgcolor="#DFEEFF" width="351"> 
                    <input type="text" name="contName" size="20" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr bgcolor="#F4FCFF">
                  <td align="right" bgcolor="#F4FCFF" width="137">电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
                  <td bgcolor="#F4FCFF" width="351"> 
                    <input type="text" name="telephone" size="20" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" width="137">传&nbsp;&nbsp;&nbsp;&nbsp;真：</td>
                  <td bgcolor="#DFEEFF" width="351"> 
                ...
                <tr>
                  <td colspan="2" align="center" bgcolor="#DFEEFF">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="addShip.jsp" target="_self"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" width="80" height="17" border="0" ></a> 
