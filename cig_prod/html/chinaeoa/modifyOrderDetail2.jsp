        ...
        <tr valign="top">
          <td>
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td class="font4b" height="13">修改订单详细信息&nbsp;</td>
  ...
  try
  {
    ...
    if("1".equals(status)||"2".equals(status)||"8".equals(status))
    {
      ...
      if(!quantity.equals(quantityOld))
      {
        ...
        if(errorCode == 0)
          out.println("订购数量修改成功!\n");
        else
          out.println("订购数量修改失败!\n");
      }
      ...
      errorCode = subOrderProc.getErrorCode();
      if(errorCode == 0)
        out.println("运送公司修改成功!\n");
      else
        out.println("运送公司修改失败!\n");
      ...
      if(errorCode == 0)
        out.println("运输方式修改成功!\n");
      else
        out.println("运输方式改失败!\n");
      subOrderProc.updateShipDate();
      if(errorCode == 0)
        out.println("送货日期修改成功!\n");
      else
        out.println("送货日期改失败!\n");
    }
    else if(status.equals("3"))
    {
      ...
      if(!quantitySend.equals(quantitySendOld))
      {
        ...
        errorCode = subOrderProc.getErrorCode();
        if(errorCode == 0)
          out.println("已送数量修改成功!\n");
        else
          out.println("已送数量修改失败!\n");
      }
      subOrderProc.setDeliveryID(deliveryID);
      subOrderProc.setShipID(shipID);
      subOrderProc.setShipMethod(shipMethod);
...
%>
            <p class="font3b"><a href="javascript:goBack()">返回</a></p>
