...
<body bgcolor="#F7FBFA" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" background="/images/temp/bg.gif" onLoad="initArea();MM_preloadImages('../image/chinaeoa2_08_0.gif','../image/chinaeoa2_09_0.gif','../image/chinaeoa2_10_0.gif','../image/chinaeoa2_11_0.gif','../image/chinaeoa2_12_0.gif','../image/chinaeoa2_13_0.gif')">
    ...
    <td width="382"> 
      <table background=/images/temp/head_dn_2.gif border=0 
        ...
        <form action="Login.jsp" method=post name=fmLogin>
          <tr align="right"> 
            <td height=28>用 户： 
              <input type="text" name="User22" size="10" class="font1">
              密 码： 
              <input type="password" name="Passwd22" size="10" class="font1">
  ...
  <tr> 
    ...
    <td valign="top" width="470"> 
      <table border=0 cellpadding=0 cellspacing=0>
        <tr> 
          <td rowspan=4 background="/image/chinaeoa2_03.gif" width="30"> <img src="/image/chinaeoa2_03.gif" width=13 height=253></td>
          <td> <img src="/image/chinaeoa2_04.gif" width=255 height=132 usemap="#Map4" border="0"><map name="Map4"><area shape="circle" coords="246,47,26" href="ProductSearch.jsp?TypeId=3&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','show','Layer2','','hide','Layer3','','hide','Layer4','','hide','Layer5','','hide','Layer6','','hide')" alt="复印机" title="复印机"><area shape="circle" coords="186,56,25" href="ProductSearch.jsp?TypeId=1&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','show','Layer3','','hide','Layer4','','hide','Layer5','','hide','Layer6','','hide')" alt="打印机" title="打印机"><area shape="circle" coords="130,77,27" href="ProductSearch.jsp?TypeId=2&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer3','','show','Layer4','','hide','Layer5','','hide','Layer6','','hide')" alt="传真机" title="传真机"><area shape="circle" coords="89,117,27" href="ProductSearch.jsp?TypeId=8&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer3','','hide','Layer4','','show','Layer5','','hide','Layer6','','hide')" alt="扫描仪" title="扫描仪"></map></td>
          <td colspan=7> <img src="/image/chinaeoa2_05.gif" width=170 height=132 usemap="#Map5" border="0"><map name="Map5"><area shape="circle" coords="4,49,22" href="ProductSearch.jsp?TypeId=3&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','show','Layer2','','hide','Layer3','','hide','Layer4','','hide','Layer5','','hide','Layer6','','hide')" alt="复印机" title="复印机"></map></td>
        </tr>
        <tr> 
          <td rowspan=3> <img src="/image/chinaeoa2_07.gif" width=255 height=121 usemap="#Map6" border="0"><map name="Map6"><area shape="circle" coords="56,15,26" href="ProductSearch.jsp?TypeId=4&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer3','','hide','Layer4','','hide','Layer5','','show','Layer6','','hide')" alt="耗材" title="耗材"><area shape="circle" coords="36,69,26" href="ProductSearch.jsp?TypeId=5&LangCode=GB" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer3','','hide','Layer4','','hide','Layer5','','hide','Layer6','','show')" alt="零件" title="零件"></map></td>
          <td rowspan=2> <a href="/train.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image1','','../image/chinaeoa2_08_0.gif',1)"><img src="/image/chinaeoa2_08.gif" width=25 height=90 border="0" name="image1" alt="培训活动"></a></td>
          <td rowspan=2> <a href="/tech.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image2','','../image/chinaeoa2_09_0.gif',1)"><img src="/image/chinaeoa2_09.gif" width=20 height=90 border="0" name="image2" alt="技术支持"></a></td>
          <td rowspan=2> <a href="/guide.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image3','','../image/chinaeoa2_10_0.gif',1)"><img src="/image/chinaeoa2_10.gif" width=19 height=90 border="0" name="image3" alt="购买指南"></a></td>
          <td rowspan=2> <a href="/service.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image4','','../image/chinaeoa2_11_0.gif',1)"><img src="/image/chinaeoa2_11.gif" width=21 height=90 border="0" name="image4" alt="客户服务"></a></td>
          <td rowspan=2> <a href="/rate.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image5','','../image/chinaeoa2_12_0.gif',1)"><img src="/image/chinaeoa2_12.gif" width=20 height=90 border="0" name="image5" alt="产品评论"></a></td>
          <td rowspan=2> <a href="/mk.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image6','','../image/chinaeoa2_13_0.gif',1)"><img src="/image/chinaeoa2_13.gif" width=22 height=90 border="0" name="image6" alt="管理知识"></a></td>
          <td> <img src="/image/chinaeoa2_14.gif" width=43 height=1></td>
        </tr>
        <tr> 
          <td> <img src="/image/chinaeoa2_15.gif" width=43 height=89></td>
        </tr>
        <tr> 
          <td colspan=7> <img src="/image/chinaeoa2_16.gif" width=170 height=31></td>
        </tr>
        <tr align="right"> 
...
<%if (LookUp.CloseStm()) 
        out.println("");%> <%if (Result.CloseStm()) 
        out.println("");%> 
</body>
</html>
