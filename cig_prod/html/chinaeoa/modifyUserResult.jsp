...
<%
        ...
        userClass = request.getParameter("powerUser");

        tempSqlStr = "update users set passwd='" + passwd + "',userLevel='" +
          userClass + "',md_date=sysdate where userID = '" + userID + "'";
...
%>
            ...
            <p>修改成功！</p>
            <p><a href="userIDList.jsp">返回</a></p>
