          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              ...
              <form name="modifyUser" method="post" action="modifyPasswdResult.jsp" onSubmit="return validateForm(modifyUser)">
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#F4FCFF">用 户 名：</td>
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#DFEEFF">&nbsp;&nbsp;原密码：</td>
                  <td bgcolor="#DFEEFF"> 
                    <input type="password" name="oldPasswd" size="15" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#F4FCFF">&nbsp;&nbsp;新密码：</td>
                  <td bgcolor="#F4FCFF">
                ...
                <tr>
                  ...
                  <td bgcolor="#DFEEFF"> <font color="#CC0000">(有效密码由字母,数字和下划线组成,长度为6~20位)</font> </td>

                </tr>
                <tr bgcolor="#F4FCFF">
                  <td align="right" bgcolor="#F4FCFF">确认密码：</td>
                  <td bgcolor="#F4FCFF">
                ...
                <tr> 
                  <td colspan="2" align="center" bgcolor="#F4FCFF">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="modifyPasswd.jsp" target="_self"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" border="0" ></a> 
                  </td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td colspan="2">&nbsp;</td>
