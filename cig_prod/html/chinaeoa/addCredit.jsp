...
<%
      ...
      {
        if(!("5".equals(userType)))           // the user should be a supplier
        {
%>
        <jsp:forward page="permError.jsp" />
<%
...
if (a[i].indexOf("#")!=0){ d.MM_p[j]=new Image; d.MM_p[j++].src=a[i];}}
  ...
  {
    if(formName.creditAmount.value != "")
    {
      for(i=0;i<formName.creditAmount.value.length;i++)
        {
          if((formName.creditAmount.value.charAt(i)<'0')||(formName.creditAmount.value.charAt(i)>'9'))
          {
            alert("输入的信用额度有误,请重新输入.");
    ...
    if(formName.pay_term.value != "")
    {
      for(i=0;i<formName.pay_term.value.length;i++)
        {
          if((formName.pay_term.value.charAt(i)<'0')||(formName.pay_term.value.charAt(i)>'9'))
          {
            alert("输入的信用期限有误,请重新输入.");
...
<%!
    ...
    String memberID,compName,suppMemberID,supplierName,supplierID;
    String tempSqlStr;
%>
<%
        ...
        <tr>
          ...
          <td>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td height="30"><img src="/images/temp/path.gif" width="49" height="13"> 
                  ...
                  <font title="里边有什么好东西呢"> 增加用户信用额度</font></font></td>
              </tr>
            </table>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr bgcolor="#99CCFF">
                <td class="font4b" align="center" width="7" valign="top"><img src="/images/temp/corner_l.gif" width="7" height="7"></td>
                <td height="25" class="font4b" align="center" bgcolor="#99CCFF">增加用户<font title="里边有什么好东西呢">信用额度</font></td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              ...
              <form name="addPayment" method="post" action="addCreditResult.jsp" onSubmit="return validateForm(addPayment)">
                <tr>
                ...
                <tr>
                  ...
                  <td bgcolor="#F4FCFF">
                    <input type="text" name="creditAmount" size="15" class="font1">元
                  </td>
                </tr>
                <tr>
                  <td align="right" bgcolor="#DFEEFF">信用期限：</td>
                  <td bgcolor="#DFEEFF">
                    <input type="text" name="pay_term" size="15" class="font1">天
