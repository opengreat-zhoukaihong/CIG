...
<%        
      ...
      {
        if(!("1".equals(userType)))       // only accessed by eoa
        {
%>
      <jsp:forward page="permError.jsp" />
<%        
...
<%!
  ...
  String compName,address,lawRep,compSize,compType,compTypeID;
  String tempSqlStr;
%>
  ...
  <tr>
    ...
    <td valign="top" colspan="2"><!-- #BeginEditable "body" --> 
      ...
      <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
        <form name="newMemberInfo" method="post"  >
          <tr bgcolor="#F4FCFF"> </tr>
          <tr bgcolor="#DFEEFF"> 
            <td align="right" size="10">用户类别：</td>
            <td bgcolor="#DFEEFF"><%=memberType%> </td>
          </tr>
          <tr> 
            <td align="right" bgcolor="#F4FCFF">国&nbsp;&nbsp;&nbsp;&nbsp;家：</td>
            <td bgcolor="#F4FCFF"><%=country%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
            <td align="right" bgcolor="#DFEEFF">省&nbsp;&nbsp;&nbsp;&nbsp;份：</td>
            <td bgcolor="#DFEEFF"><%=province%> </td>
          </tr>
          <tr> 
            <td align="right" bgcolor="#F4FCFF">所在城市：</td>
            <td bgcolor="#F4FCFF"><%=city%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
          ...
          <tr> 
            ...
            <td bgcolor="#F4FCFF"><%=address%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
            <td align="right" bgcolor="#DFEEFF">邮政编码：</td>
            <td bgcolor="#DFEEFF"><%=zipCode%> </td>
          </tr>
          <tr> 
            <td align="right" bgcolor="#F4FCFF">联系电话：</td>
            <td bgcolor="#F4FCFF"><%=telephone%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
          ...
          <tr> 
            ...
            <td bgcolor="#F4FCFF"> <%=contTitle%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
            <td align="right"><b bgcolor="#DFEEFF">E-mail : </b ></td>
            <td bgcolor="#DFEEFF"><%=contEmail%> </td>
          </tr>
          <tr> 
            <td bgcolor="#F4FCFF"><b bgcolor="#F4FCFF"><font color="#990033"> 
              &nbsp;&nbsp;&nbsp;&nbsp;</font></b></td>
            <td bgcolor="#F4FCFF">&nbsp;</td>
          </tr>
          <tr> 
            <td align="right" bgcolor="#DFEEFF">密码提示：</td>
            <td bgcolor="#DFEEFF"><%=question%> </td>
          </tr>
          <tr bgcolor="#DFEEFF"> 
            <td align="right" bgcolor="#F4FCFF">答&nbsp;&nbsp;&nbsp;&nbsp;案： </td>
            <td bgcolor="#F4FCFF"><%=answer%> </td>
          </tr>
          <tr> 
            <td bgcolor="#DFEEFF"><b bgcolor="#DFEEFF"><font color="#990033">&nbsp;&nbsp;&nbsp;&nbsp;</font></b></td>
