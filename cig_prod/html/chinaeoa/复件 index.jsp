  ...
  <tr> 
    ...
    <td valign="top" width="470"> 
      <table border=0 cellpadding=0 cellspacing=0>
        <tr> 
          <td rowspan=4 background="/images/chinaeoa2_03.gif" width="30"> <img src="/images/chinaeoa2_03.gif" width=13 height=253></td>
        ...
        <tr> 
          ...
          <td rowspan=2> <a href="/rate.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image5','','../images/chinaeoa2_12_0.gif',1)"><img src="/images/chinaeoa2_12.gif" width=20 height=90 border="0" name="image5" alt="产品评论"></a></td>
          <td rowspan=2> <a href="/mk.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('image6','','../images/chinaeoa2_13_0.gif',1)"><img src="/images/chinaeoa2_13.gif" width=22 height=90 border="0" name="image6" alt="管理知识"></a></td>
