...
<%!
    ...
    String memberID,supplierID,creditAmount,pay_term,amountUsed,compName;
    String tempSqlStr;
    int errorCode;
...
<%
        ...
        amountUsed = request.getParameter("amountUsed");

        tempSqlStr = "update payment set creditAmount = '" + creditAmount +
          "',pay_term = '" + pay_term + "',amountUsed = '" + amountUsed +
          "',md_date=sysdate where memberID = '" +
          memberID + "' and supplierID = '" + supplierID + "'";
...
<form name="browseList" method="post" action="searchPaymentResult.jsp">
