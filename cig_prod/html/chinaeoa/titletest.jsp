...
<table border=0 cellpadding=0 cellspacing=0 width=752>
  ...
  <tr> 
    <td width=752> 
      <table border=0 cellpadding=0 cellspacing=0 height=46 width=711>
        <tbody> 
        <tr> 
          ...
          <td width="428"> 
            ...
            cellpadding=0 cellspacing=0 height=46 width=382>
              <form action="" method=post name=fmQuery>
                <tr align="right"> 
                  ...
                  onChange=changeProvinceInfo(Brand,ProductNo) size=1>
                    ...
                    <a 
                  href="javascript:Query()"><img border=0 height=16 
                  src="/images/temp/b_searchTitle.gif" width=44></a> <a 
                  href="index.jsp"><img border=0 height=16 
                  src="/images/temp/b_login.gif" width=44></a> </td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                </tr>
