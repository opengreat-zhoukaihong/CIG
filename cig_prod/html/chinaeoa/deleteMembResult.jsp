...
<%!
    String memberID;
    int errorCode;
    String condMemberName,memberType,registDate,status,action,pageNo;
%>
<%
        condMemberName = request.getParameter("name");
...
<FORM NAME="browseList" action="searchMembResult.jsp" METHOD="post" >
  ...
  <input type="hidden" name="name" value="<%=condMemberName%>">
...
<%
      ...
      memberManager.setMemberID(memberID);
...
%>
            ...
            <p>É¾³ý³É¹¦£¡</p>
            <p><a href="javascript:goBack()">·µ»Ø</a></p>
<%
        }
        else
        {
%>
            <p>É¾³ýÊ§°Ü£¡</p>
            <p><a href="javascript:history.go(-1);">·µ»Ø</a></p>
