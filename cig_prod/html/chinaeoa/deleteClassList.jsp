...
if (a[i].indexOf("#")!=0){ d.MM_p[j]=new Image; d.MM_p[j++].src=a[i];}}
  ...
  function deleteClass(mbID,spID)
  {
    if(confirm("确实要删除吗?"))
    {
...
<%!
    ...
    String memberID,compName,memberClassID,memberClass;
    String url;
    String tempSqlStr;
%>
<%
        ...
        <tr>
          ...
          <td>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td height="30"><img src="/images/temp/path.gif" width="49" height="13"> 
                  ...
                  <font title="里边有什么好东西呢"> 删除用户级别</font></font></td>
              </tr>
            </table>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr bgcolor="#99CCFF"> 
                <td class="font4b" align="center" width="7" valign="top"><img src="/images/temp/corner_l.gif" width="7" height="7"></td>
                <td height="25" class="font4b" align="center" bgcolor="#99CCFF">删除用户<font title="里边有什么好东西呢">级别</font></td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              ...
              <form name="delCredit" method="post" action="deleteClassResult.jsp">
                <tr>
                  ...
                  <td colspan="2" bgcolor="#F4FCFF">
                    <table width="500" border="0" cellspacing="0" cellpadding="0">
                      <tr align="center">
                        ...
                        <td bgcolor="#99CCFF" height="20">用户级别
...
<%
        ...
        if(paymentInfo != null)
        {
          ...
          {
            url ="deleteClassResult.jsp?memberID=" + memberID +
              "&supplierID=" +paymentInfo.getString("supplierID");
            memberClassID = paymentInfo.getString("class");
            if(memberClassID.equals("1"))
              memberClass = "一级用户";
            else if(memberClassID.equals("2"))
              memberClass = "二级用户";
            else if(memberClassID.equals("3"))
              memberClass = "三级用户";
            else if(memberClassID.equals("4"))
              memberClass = "四级用户";
            else if(memberClassID.equals("5"))
              memberClass = "五级用户";
            else
              memberClass = "";
...
%>
                      ...
                      <tr align="center">
                        ...
                        <td><%= memberClass %></td>
                        <td><a href="javascript:deleteClass(<%=memberID%>,<%=paymentInfo.getString("supplierID")%>)" >[删除]</a></td>
                      </tr>
<%
          }
