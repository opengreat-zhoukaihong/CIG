        ...
        <form name="newMemberInfo" method="post" action="addSuppResult.jsp" onSubmit="return validateForm(newMemberInfo)">
          ...
          <tr bgcolor="#DFEEFF"> 
            ...
            <td bgcolor="#DFEEFF"> 
              <select name="memberType" >
                <option value="5" selected>代理商</option>
          ...
          <tr> 
            <td colspan="2" align="center" bgcolor="#DFEEFF"> 
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="addSupplier.jsp" target="_self"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" border="0"></a> 
            </td>
          </tr>
          <tr bgcolor="#F4FCFF"> 
            <td colspan="2">&nbsp;</td>
