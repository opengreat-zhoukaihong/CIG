<%@ page import="java.util.*, java.sql.*,java.io.*,java.net.URLEncoder,java.net.URLDecoder" session="true" language="java" errorPage="error.jsp"%>
<%-- the page is only accessible to eoa --%>
<%!
    String highLevel = "5";
...
<%
        ...
        if(paymentInfo != null)
        {
          ...
          {
            url ="modifyClass.jsp?memberID=" + memberID +
...
%>
                      <tr align="center">
                        <td><a href="<%=url+URLEncoder.encode(paymentInfo.getString("compName"))%>" ><%= paymentInfo.getString("compName") %></a></td>
                        <td><%= memberClass%></td>
                        <td><a href="<%=url+URLEncoder.encode(paymentInfo.getString("compName"))%>" >[修改]</a></td>
                      </tr>
<%
          }
