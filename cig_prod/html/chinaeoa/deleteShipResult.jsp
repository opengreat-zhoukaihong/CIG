...
<%
        ...
        tempSqlStr = "delete shipment_L where shipID='" + shipID + "' and lang_code = '" +
          lang_code + "'";

        modifyShip.setSqlStr(tempSqlStr);

        tempSqlStr = "delete shipment where shipID ='" + shipID + "'";
...
%>
            <p>操作成功!</p>
            <p><a href="shipList.jsp?action=delete">返回</a></p>
