...
<%!
    ...
    String userDesc[] = new String[] {"普通用户","操作用户","初审用户","高审用户","超级用户"};;
%>

<%
        userID = request.getParameter("userList");

        tempSqlStr = "select passwd,userLevel from users where userID = '" +
          userID + "'";
        ...
        if(userInfo != null)
        {
          if(userInfo.next())
          {
            passwd = userInfo.getString("passwd");
            userClass = userInfo.getString("userLevel");
          }
          userManager.disconn();
        }
        ...
        <tr>
          ...
          <td>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td height="30"><img src="/images/temp/path.gif" width="49" height="13">
                  ...
                  <font title="里边有什么好东西呢"> 修改用户信息</font></td>
              </tr>
            </table>
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr bgcolor="#99CCFF">
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              ...
              <form name="modifyUser" method="post" action="modifyUserResult.jsp" onSubmit="return validateForm(modifyUser)">
                ...
                <tr> 
                  ...
                  <td bgcolor="#F4FCFF"> 
                    <input type="password" name="passwd1" value="<%=passwd%>" size="15" class="font1">
                    <font color="#CC0000">*&nbsp;(有效密码由字母,数字和下划线组成,长度为6~20位)</font> </td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#DFEEFF">确认密码：</td>
                  <td bgcolor="#DFEEFF"> 
                    <input type="password" name="passwd2" value="<%=passwd%>" size="15" class="font1">
                    <font color="#CC0000">*</font> </td>
                </tr>
                <tr> 
                  <td align="right" bgcolor="#F4FCFF">用户级别：</td>
                  <td bgcolor="#F4FCFF">
                    <select name="powerUser">

                <%  for(int i=1;i<6;i++)
                    {
                      if(userClass.equals(String.valueOf(i)))
                      {
                %>
                      <option value="<%=i%>" selected><%=userDesc[i-1]%></option>
                <%    }
                      else
                      {
                %>
                      <option value="<%=i%>" ><%=userDesc[i-1]%></option>
                <%
                      }
                     }
                %>
