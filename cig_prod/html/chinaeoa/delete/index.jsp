...
" brand b, category c where p.cateid = c.cateid and p.brandid = b.brandid and b.lang_code = 'GB' and p.typeid<4 order by p.brandid,p.cateid, p.productno",3,"CateName")%>);//
  ...
  function changeProvinceInfo(countryBox,provinceBox)
  {
    ...
    if(countryItem>0)
    {
      ...
      if((document.fmSearch.NewProcductNo.value==null)||(document.fmSearch.NewProductNo.value==""))
              ...
              <tr>
                <td height="28">用 户：
                  ...
                  <input type="password" name="Passwd" size="10" class="font1">
                    ...
                    <a href="rpass1.jsp"><img src="/images/temp/b_pw.gif" width="57" height="15" border="0"></a></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr></form>
