...
String facilityEnv = myUpload.getRequest().getParameter("FacilityEnv");
...
pqHotel.setParameter(22,"admin");
pqHotel.setParameter(23,"testsdfsdf");
...
db.closeConection();
if (isInsertHotel && isInsertHotelL)
  response.sendRedirect("HotelModify.jsp?HotelId=666.jsp?HotelId=" + hotelId + "&LangCode=" + langCode);
%>
