    ...
    <td>
      ...
      <input type=hidden name="ope_ID" value="<%=ope_ID%>" >
        ...
        <table width="400" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#ffffff">
         ...
         <tr> 
            <td width="90" class="font9">航班号 ：</td>
            <td class="font9"> 
              <input name="flightID" size="20" >
            </td>
          </tr>
          <tr> 
            <td width="90" class="font9">起飞城市：</td>
            <td class="font9">
            <select size="1" name="fromCityID" >
          ...
          <tr> 
            <td width="90" class="font9">到达城市：</td>
            <td class="font9"> 
            <select size="1" name="toCityID" >
            <option value="">全部</option>
            <%for(int i=0;i<cityCount;i++){%>
            <option value="<%=cityList[i][0]%>"><%=cityList[i][1]%></option>
            <%}%>
          ...
          <tr> 
            <td width="90" class="font9">起飞机场：</td>
            <td class="font9">
            <select size="1" name="fromPortID">
            <option value="">全部</option>
          ...
          <tr> 
            <td width="90" class="font9">到达机场：</td>
            <td class="font9"> 
            <select size="1" name="toPortID">
            <option value="">全部</option>
           <%for(int i=0;i<portCount;i++){%>
           <option value="<%=portList[i][0]%>" ><%=portList[i][1]%></option>
           <%}%>
          ...
          <tr> 
            <td width="90" class="font9">航空公司：</td>
            <td class="font9">
