      ...
      <form name= fmAddHotel method="post" action="UpdateHotel.jsp" enctype="multipart/form-data">
        <table width="550" border="0" cellspacing="2" cellpadding="5" height="40">
          <tr> 
            ...
            <td height="30" class="font12" align="right"><a href="HotelModify.jsp?HotelId=<%=quHotel.getFieldValue("Hotel_id")%>&LangCode=EN">英文  </a>
            <a href="HotelModify.jsp?HotelId=<%=quHotel.getFieldValue("Hotel_id")%>&LangCode=GB">中文</a></td>
          </tr>
        </table>
        <table width="554" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#ffffff">
          ...
          <tr class="font9"> 
            ...
            <td width="179"> 
              <select name="StateId" size="1" onChange="changeCityInfo(CountryId,StateId,CityId)" onBlur="saveProvince()">
       		...
       		out.print(sqlProvide.getSql("Bst.SetState"));
       		out.print(quHotel.getFieldValue("State_id"));
       		out.print(dbLookup.setLookUp());
       	      %> 
              </select>
              * </td>
          ...
          <tr class="font9"> 
            <td width="78">邮政编号：</td>
            <td width="179"> 
              <input name="Postcode" value="<%=quHotel.getFieldValue("Postcode").equals("null")?"":quHotel.getFieldValue("Postcode")%>" 
           >
            </td>
            <td width="63" class="font9" height="37">电话：</td>
            <td width="174" height="37"> 
              <input name="Tel" value="<%=quHotel.getFieldValue("tel").equals("null")?"":quHotel.getFieldValue("tel")%>" 
          ...
          <tr class="font9"> 
            ...
            <td width="179"> 
              <input name="Fax"  value="<%=quHotel.getFieldValue("fax").equals("null")?"":quHotel.getFieldValue("fax")%>"
           >
            </td>
            <td width="63" class="font9">电子信箱：</td>
            <td width="174"> 
              <input name="Email" value="<%=quHotel.getFieldValue("email").equals("null")?"":quHotel.getFieldValue("email")%>" 
           >
            </td>
          </tr>
          <tr class="font9"> 
            ...
            <td width="174"> 
              <input name="Contact" value="<%=quHotel.getFieldValue("Contact").equals("null")?"":quHotel.getFieldValue("Contact")%>"
           >
            </td>
          </tr>
          <tr> 
            ...
            <td colspan="3" class="font9"> 
              <input name="Url" size="50" value="<%=quHotel.getFieldValue("url").equals("null")?"":quHotel.getFieldValue("url")%>">
            </td>
          </tr>
          <tr class="font9"> 
          ...
          <tr> 
            ...
            <td class="font9"><img src="<%=imageDir + quHotel.getFieldValue("ImageFile1")%>" width="150" ></td>
          </tr>
          <tr> 
            ...
            <td class="font9"><img src="<%=imageDir + quHotel.getFieldValue("ImageFile2")%>"  width="150"></td>
          </tr>
          <tr class="font9"> 
            ...
            <td><img src="<%=imageDir + quHotel.getFieldValue("ImageFile3")%>" width="150" ></td>
          </tr>
          <tr class="font9"> 
          ...
          <tr class="font9"> 
            ...
            <td><img src="<%=mapDir + quHotel.getFieldValue("MapFileName")%>" width="150" ></td>
          </tr>
          <tr class="font9"> 
            <td width="78" class="font9">要求推荐：</td>
            <td width="179"> <% 
              if (quHotel.getFieldValue("PROMOTION").equals("Y"))
              {
              %> 
          ...
          <tr class="font9"> 
            ...
            <td colspan="3" height="38">
              <input type="text" name="Location" maxlength="100" size="50" value="<%=quHotel.getFieldValue("Location").equals("null")?"":quHotel.getFieldValue("Location")%>">
            </td>
          </tr>
          <tr class="font9"> 
            <td width="78" class="font9">餐饮设施：</td>
            <td colspan="3"> 
              <TEXTAREA cols=50 name=FacilityDrink><%=quHotel.getFieldValue("Facility_Drink").equals("null")?"":quHotel.getFieldValue("Facility_Drink")%></TEXTAREA>
            </td>
          </tr>
          <tr class="font9"> 
            <td width="78" class="font9">娱乐设施：</td>
            <td colspan="3"> 
              <textarea cols=50 name=FacilityEnt><%=quHotel.getFieldValue("Facility_Ent").equals("null")?"":quHotel.getFieldValue("Facility_ent")%></textarea>
            </td>
          </tr>
          <tr class="font9"> 
            <td width="78" class="font9">服务设施：</td>
            <td colspan="3"> 
              <TEXTAREA cols=50 name=FacilityServ><%=quHotel.getFieldValue("Facility_serv").equals("null")?"":quHotel.getFieldValue("Facility_serv")%></TEXTAREA>
            </td>
          </tr>
          <tr> 
            <td width="78" class="font9">详细描述：</td>
            <td colspan="3"> 
              <textarea cols=50 name=FullDescr><%=quHotel.getFieldValue("FullDescr").equals("null")?"":quHotel.getFieldValue("FullDescr")%></textarea>
            </td>
          </tr>
          <tr class="font9"> 
            <td width="78" class="font9">备注：</td>
            <td colspan="3"> 
              <textarea cols=50 name=Remark><%=quHotel.getFieldValue("Remark").equals("null")?"":quHotel.getFieldValue("Remark")%></textarea>
            </td>
          </tr>
        </table>
        <%
        ...
        <table width="550" border="0" cellspacing="0" cellpadding="0">
          <tr align="middle"> 
            <td height="40"> <A href="JavaScript:PostForm()"><IMG border=0 height=26 src="/images/botton_update.gif" width=68></A><IMG height=1 src="images/dot.gif" width=50> 
              ...
              <td><a href="HotelBKPriceList.jsp?hotel_ID=<%=quHotel.getFieldValue("Hotel_Id")%>">酒店价格</a></td>
          </tr>
        </table>
       <%}%>
      </form>
