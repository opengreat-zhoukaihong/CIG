    ...
    <td>
      <form name=fmPriceSearch method="post" action="in_price_table2.jsp">
        ...
        <table width="400" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#ffffff">
          ...
          <tr> 
            <td width="90" class="font9">城　　市：</td>
            <td> 
              <select name="cityID">
                <option value="0">所有城市</option>
                <option value="3">北京</option>
                <option value="54">上海</option>
                <option value="12">广州</option>
                <option value="18">深圳</option>
                <option value="58">香港</option>
                <option value="2">澳门</option>
                <option value="45">大连</option>
                <option value="A">其他城市</option>
              </select>
            </td>
          </tr>
          <tr align="middle"> 
