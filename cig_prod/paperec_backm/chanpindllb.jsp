    ...
    <td height="257" valign="top"><!-- #BeginEditable "body" --><br>
      ...
      <input type="HIDDEN" name="action">
        ...
        <table width="600" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#4078e0" bordercolordark="#FFFFFF">
          <tr> 
            <td colspan="8" class="title12" height="33">产品大类列表：
            	...
            	<%=(class_flag.equals("C"))?"国内":"国外"%>
            </td>
          </tr>
          <tr align="center"> 
            <td width="61"><b>大类ID</b></td>
            <td width="80"><b>语言代码</b></td>
            <td width="78"><b>大类名称</b></td>
            <td width="54">&nbsp;</td>
            <td width="43">&nbsp;</td>
            <td width="51">&nbsp;</td>
            <td width="73">&nbsp;</td>
          ...
          <tr align="center"> 
            ...
            <td width="54"><a href="chanpinedit.jsp?fromFlag=1&classFlag=<%=class_flag%>&cateId=<%=cate_list[i][0]%>&langCode=<%=cate_list[i][1]%>">编辑</a></td>
            <td width="43"><a href="deleteCate.jsp?classFlag=<%=class_flag%>&action=delete&cateId=<%=cate_list[i][0]%>" onClick="return confirmDelete()">删除</a></td>
            <td width="51"><a href="chanpindl_gglb.jsp?cateId=<%=cate_list[i][0]%>">查看规格</a></td>
            <td width="73"><a href="chanpinzllb.jsp?classFlag=<%=class_flag%>&cateId=<%=cate_list[i][0]%>">查看下属中类</a></td>
            <td width="78"><a href="chanpinfenleigllb.jsp?cateId=<%=cate_list[i][0]%>">查看分类关联</a></td>
          </tr>
          <%  }
            }
          %>
