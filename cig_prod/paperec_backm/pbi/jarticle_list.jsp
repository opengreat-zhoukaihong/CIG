      ...
      <table border="0" cellpadding="0" cellspacing="0" width="500">
	    ...
	    <input type="hidden" name="action" value="">
              ...
              <table width="650" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#FFFFFF">
                <tr>
                  <td class="font9" colspan="6" align="left">共有<%=totalCount%>条记录，共<%=totalPage%>页</td>  
                ...
                <tr align="center"> 
                  ...
                  <td class="font9" width="120" height="15">[<a href="jarticle_process.jsp?action=remove&journalId=<%=jArticles[i].getJournalId()%>&columnId=<%=jArticles[i].getColumnId()%>&articleId=<%=jArticles[i].getArticleId()%>" class="font9">文稿移出</a>]</td>
                </tr>
                <% }
                  }
                %>
