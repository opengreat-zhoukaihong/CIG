...
<%
    ...
    disp_cont = ContTemp.getDispCont();    
...
<table border="0" cellspacing="0" cellpadding="0" width="675">
  <tr>   
    <td height="257" valign="top"><!-- #BeginEditable "body" -->
      <form name="contEditForm" method="post" action="htmuban_lb.jsp">
      <input type="HIDDEN" name="action" value="">
      <input type="HIDDEN" name="contFlag" value=<%=cont_flag%>>
      ...
      <input type="HIDDEN" name="sno" value=<%=sno%>>
        ...
        <table width="400" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#4078e0" bordercolordark="#FFFFFF">
          ...
          <tr> 
            <td colspan="2">显示内容：
              <input type="text" name="editDispCont" value="<%=disp_cont%>">
