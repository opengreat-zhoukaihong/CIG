    ...
    <td height="257" valign="top"><!-- #BeginEditable "body" --><br>
      ...
      <input type="HIDDEN" name="action">
        ...
        <table width="600" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#4078e0" bordercolordark="#FFFFFF">
          <tr> 
            <td colspan="4" class="title12" height="33">参数列表：
                <img src="../images/space.gif" width="150" height="1">
            </td>
          </tr>
          <tr align="center"> 
            <td width="80"><b>参数代码</b></td>
            <td width="80"><b>语言代码</b></td>
            <td width="160"><b>参数内容</b></td>
            <td width="54">&nbsp;</td>
          </tr>
          <%
            if (para_count>0){
          ...
          <tr align="center"> 
            ...
            <td width="54"><a href="xitongcslb.jsp?action=delete&id=<%=id%>&code=<%=para_list[i][0]%>&langCode=<%=para_list[i][1]%>" onClick="return confirmDelete()">删除</a></td>
          </tr>
          <%  }
            }
          %>
