    ...
    <td><!-- #BeginEditable "body" --><br>
      <form method="post" action="shuru_shanchu.jsp">
        <table width="550" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#4078e0" bordercolordark="#FFFFFF">
          <tr> 
            <td colspan="4" class="title12" height="33">请输入关联公司ID
                <img src="../images/space.gif" width="150" height="1">
            </td>
          </tr>
          <tr> 
            <td align="center" width="120">公司ID：</td>
            <td width="408">
              <input type="text" name="company_id">
              <input type="hidden" name="company_id1" >
              <input type="hidden" name="act" value="begin">
              <input type="image" border="0" name="imageField" src="../images/jixu.gif" width="68" height="26">
            </td>
          </tr>
        </table>
      </form>
