...
function PostForm(I)
{
  if ( I ==3)
  {
    ...
    wStr = wStr + "'0'";
    fmOpen.method="post";
    fmOpen.action = "/cnhotel/servlet/com.dreamerland.cnhotelbooking.bst.CbstDelRow?TableName=Country_gb&ID=" + wStr;
    fmOpen.submit();
  }
  else if ( I == 1)
  {
    fmOpen.action = "cnhotel/bst/open_Country.jsp?PageFlag=PREV";
    fmOpent.submit();
  }
  else if ( I == 2)
  {
    fmOpen.action = "cnhotel/bst/open_Country.jsp?PageFlag=NEXT";
    fmOpen.submit();
  }
            ...
            <form name=fmOpen  action="">
              ...
              <table width="400" border="1" cellspacing="2" cellpadding="5" bordercolorlight="#f9c026" bordercolordark="#FFFFFF">
                <tr align="center"> 
                  ...
                  <td class="font9" width="59">国家名称</td>
                  <td class="font9" colspan="3">说明</td>
                </tr>
<jsp:include page="/servlet/com.dreamerland.cnhotelbooking.bst.CbstOpenCountry" flush="true" />              </table>
            </form>
          </td>
        </tr>
      </table>
