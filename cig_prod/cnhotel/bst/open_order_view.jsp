...
function PostForm(I)
{
  ...
  {
    fmOrderResult.action = "/cnhotel/bst/open_order_view.jsp?PageFlag=PREV";
    fmOrderResult.submit();
  }
  else if ( I == 2)
  {
    fmOrderResult.action = "/cnhotel/bst/open_order_view.jsp?PageFlag=NEXT";
    fmOrderResult.submit();
  }
...
<%
//batia do that
//          out.println((String)session.getValue("login.id"));
%>
...
<jsp:include page="/servlet/com.dreamerland.cnhotelbooking.bst.CbstOpenOrder" flush="true" />                
