...
<form name="measConvForm" method="post" action="huansuanresult.jsp">
  <table width="275" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#E6EDFB">
    ...
    <tr> 
      <td align="center" colspan="2">度量值： 
        <input type="text" name="value1" size="8" value="1.00" >
        度量类别： 
        <select name="measFlag" onChange="changeUnit1()">
          <option value="L" selected> 长度 </option>
          <option value="W"> 重量 </option>
          <option value="V"> 容积 </option>
        </select>
      </td>
    </tr>
    <tr> 
      <td align="center" colspan="2">度量单位： 
        <select name="unit1">
    ...
    <tr> 
      <td colspan="2"> 
        <table width="275" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td bgcolor="#B0C8F0" align="right" width="209" height="20">值</td>
            <td bgcolor="#B0C8F0">&nbsp;</td>
            <td bgcolor="#B0C8F0" width="191" height="20">单位</td>
          </tr>
