          ...
          <tr bordercolor="#FFFFFF"> 
            <td> 
              <table width="500" border="0" cellspacing="1" cellpadding="1" >
                <tr> 
                  <td colspan="5" class="font14" bgcolor="#D8E4F8" height="27"><b class="font14">个人信息中心<img src="../images/space.gif" width="240" height="1"> 
                    <span class="font10">共有<%= MessageList.getTotalPage() %>页，共<%= MessageList.getMessageCount() %>条信息</span></b></td>
                </tr>
                <tr> 
                  <td colspan="5" class="font10" bgcolor="#D8E4F8" height="27">点击ID号或主题可查看详细信息</td>
                </tr>
                <tr height ="30"> 
                  <td width="56" bgcolor="#B0C8F0" class="dan10" align="center">读标志</td>
                  <td width="81" bgcolor="#B0C8F0" class="dan10" align="center">编号</td>
                  <td width="241" bgcolor="#B0C8F0" class="dan10" align="center">主题</td>
                  <td width="105" bgcolor="#B0C8F0" class="font10" align="center">日期</td>
