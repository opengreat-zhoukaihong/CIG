          ...
          <tr bordercolor="#FFFFFF"> 
            <td height="145"> 
              <table width="400" border="0" cellspacing="2" cellpadding="4">
                <tr> 
                  <td colspan="2" height="25" bgcolor="#4078E0"><font color="#FFFFFF"><b>我的客户</b></font></td>
                </tr>
                <%     String str=""; int j=comp.length;   %>
                <%    if(j==0){   %>
                <tr> 
                  <td colspan="2" height="22" class="dan10">
                   这个设置是为方便您通知您的老客户而准备的。目前您还没有在本网上和别的会员达成交易，
                   即您还没有您的老客户档案，因此此设置尚无法为您服务。
                  </td> 
                </tr>
                <tr>
                <td height="25"> 
                ...
                <%   }    %> 
                <tr>                  
                  <td colspan="2" height="22" class="dan10">请输入发布号 
