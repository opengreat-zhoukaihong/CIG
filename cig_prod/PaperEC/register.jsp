    ...
    <td valign="top" height="879"> 
      <form method="post" action="revert.jsp" name="putin" onSubmit="return validateForm(putin);">
        <table width="604" border="0" cellspacing="0" cellpadding="4" bgcolor="#E6EDFB">
          <tr> 
            <td height="26">欢迎来到注册页面。请认真填写下面表格所列各项，带<font color="#FF3300">*</font>号的为必填项。</td>
          </tr>
          <tr bgcolor="#7EA2EB"> 
            ...
            <td> 
              <table width="604" border="0" cellspacing="0" cellpadding="4">
                <tr> 
                  ...
                  <td width="322"><font color="#FF3300">*  </font>（只能用a-z,A-Z,0-9和下划线 _ 的组合，4-16个<br>&nbsp&nbsp&nbsp字符，区分大小写） 
                  </td>
                </tr>
                <tr> 
                  ...
                  <td width="322"><font color="#FF3300">*  </font>（只能用a-z,A-Z,0-9和下划线 _ 的组合，6-16个<br>&nbsp&nbsp&nbsp字符，区分大小写） 
                  </td>
                </tr>
                <tr> 
          ...
          <tr> 
            <td> 
              <table width="604" border="0" cellspacing="0" cellpadding="4">
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=9 and lang_code='GB' order by str_value" /> 
                  <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
            ...
            %> 
              ...
              while(arr[i]!=null){
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=3 and lang_code='GB' order by str_value" /> 
         <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
          ...
          %> 
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=7 and lang_code='GB' order by str_value" /> 
      <%     allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
               arr[i]=allData.getString("str_value");
        ...
        %> 
               ...
               <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=11 and lang_code='GB' order by str_value" /> 
          <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
          ...
          %> 
              ...
              for(i=0;i<v.size();i++){
                ...
                <tr> 
                  <td width="117" align="center">通讯地址：</td>
                  <td colspan="2"> 
                ...
                <tr> 
                  ...
                  <td colspan="2"> 
                    <input type="text" name="p_tel_c" ><font color="#FF3300">  * </font>
                  </td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td colspan="3">对您在本网的交易活动，本网可以提供电子邮件的即时自动通知服务，请您选择：
                  <input type="radio" name="email_info" value="Y">需要
                  <input type="radio" name="email_info" value="N" checked>不需要 <font color="#FF3300"> * </font>
                  </td>
                </tr>                
                <tr> 
                  <td colspan="3">如果您需要这个服务，请填入您的电子邮箱：
                    <input type="text" name="p_email_c" size="30">
                  </td>
                </tr>
                <tr> 
                  <td colspan="3">
                    假如您暂时还没有电子邮箱，请不要在电子邮箱输入框内填任何内容，本网将免费送您一个电子邮箱：<br>
                      
                    <div align="center"><br>
                      <font color="#990000">您的用户名@mail.paperec.com </font></div>
                    <br>
                      电子邮箱帐号的用户名和密码就是您上面选择的用户名和密码。 
                  </td>
          	</tr>
                <tr> 
                  <td colspan="3"> 
          ...
          %> 
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=5 and lang_code='GB' order by str_value" /> 
          <%    
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
