...
<jsp:setProperty name="PostingPagePara" property="langCode" value="GB" />
<jsp:setProperty name="PostingPagePara" property="classFlag" value="C" />
...
<% if ( !(UserInfo.getApproved().equals("Y")) 
	...
	<jsp:forward page="inform.jsp?info=很抱歉,您未被授权进行供应发布!" />
	</jsp:forward>
<% }%>

<% if ( !PersonalProd.getApproved()){%>
	<jsp:forward page="inform.jsp?info=很抱歉,您的产品未被授权进行供应发布!" />
	</jsp:forward>
<% }%>
...
#cont_bid_shipDate1{position: absolute; left: ; top: ; } 
#cont_bid_shipDate2{position: absolute; left: ; top: ; } 
</style> 
          ...
          <tr bordercolor="#FFFFFF"> 
            <td > 
              <table width="600" border="0" cellspacing="0" cellpadding="2" bgcolor="#E6EDFB">
                <tr> 
                  <td colspan="3" height="25" bgcolor="#4078E0"><font color="#FFFFFF" class="big"><b>供应发布 
                    </b> </font></td>
                </tr>
                <tr> 
		...
		<input type="HIDDEN" name="requestPostingId" value="<%=PostingPagePara.requestPostingId%>">
                <tr> 
                  <td width="184" align="center" class="dan10"> 
                    <select name="list1" size="7" class="list2" ONCHANGE="javascript: alert('不可更改!'); selectProduct(document.mainInputForm.cateId.value);" <%--"ChangeProduct();"--%>>
                      <option>个人产品规格</option>
                    </select>
                  </td>
                  <td width="184" align="center" class="dan10"> 
                    <select name="list2" size="7" class="list2" ONCHANGE="javascript: alert('不可更改!'); selectPaperType(document.mainInputForm.typeId.value);" <%--"recreateGrades();"--%>>
                      <option>个人产品规格</option>
                    </select>
                  </td>
                  <td width="184" align="center" class="dan10"> 
                    <select name="list3" size="7" class="list2" ONCHANGE="javascript: alert('不可更改!'); selectGrade(document.mainInputForm.gradeId.value);">
                      <option>个人产品规格</option>
                    </select>
                  </td>
                </tr>
                ...
                <tr> 
                  <td colspan="3" class="dan10" align="center" bgcolor="#E6EDFB" height="40"> 
                    点击指标名称，可以输入指标的取值范围。
                  </td>
                </tr>
...
<input type="HIDDEN" name="bid_destCityId_h" value=>
		    ...
		    <%}%>
                ...
                <tr valign="top"> 
                  <td colspan="3" bgcolor="#E6EDFB"> 
                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><img src="../../images/origin_offer.gif" width="127" height="26"></td>
                      </tr>
                      <tr>
                        <td>
				...
				<%}%>
                                ...
                                报价： 
                                <input type="text" name="bid_price" size="12" onBlur="validField(this);">
                              </td>
                            </tr>
                            <tr bgcolor="#E6EDFB"> 
				...
				<%}%>
                            ...
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22" bgcolor="#E6EDFB">
                                <div id="cont_bid_shipDate1" class="dan10">
                                交货日期
                                </div> 
                                <div id="cont_bid_shipDate2" class="dan10">
                                装船日期
                                </div> 
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;
                ...
                <tr bgcolor="#E6EDFB" align="center"> 
                  <td colspan="3" class="big" height="25"> <font color="#FFFFFF"><b> 
                    <input type="button" name="Submit2" value="发 布" onClick="javascript:submitPage()">
...
function currencyChanged() {
	...
	if (currencyVal == 'USD') {
		...
		attr.css.visibility='hidden';
		attr = new makeAttr('cont_bid_shipDate1', ''); 
		attr.css.visibility='hidden';
		attr = new makeAttr('cont_bid_shipDate2', ''); 
		attr.css.visibility='visible';
	} 
	else {
		attr = new makeAttr('cont_bid_deliMeth', ''); 
