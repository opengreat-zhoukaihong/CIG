          ...
          <tr bordercolor="#FFFFFF"> 
            <td height="145"> 
              <table width="600" border="0" cellspacing="1" cellpadding="2">
                <tr bgcolor="#4078E0"> 
                  <td colspan="8" height="25"><font color="#FFFFFF">个人产品资料</font></td>
                </tr>
                <tr align="center" bgcolor="#7EA2EB"> 
                  <td width="88" class="white10">产品名称</td>
                  <td width="90" class="white10">类别</td>
                  <td width="88" class="white10">产品</td>
                  <td width="63" class="white10">型号</td>
                  <td width="75" class="white10">品牌</td>
                  <td width="68" class="white10">产地</td>
                  <td width="67">&nbsp;</td>
                  <td width="61">&nbsp;</td>
                </tr>
     ...
     <% try{   
               ...
               <%    ss="select str_value from parameter where id=12 and lang_code='"+lang_code+"' and code='"+st[1]+"'";
                ...
                <tr bgcolor="#E6EDFB"> 
                  ...
                  <td width="67" align="center" class="dan10"><a href="prodInfo.jsp?editPage=true&productId=<%=st[8]%>"><font color="#4078E0">编 辑</a></td> 
                  <td width="67" align="center" class="dan10"><a href="offer2sale.jsp?productId=<%=st[8]%>&requestPostingId=<%=posting_id%>"><font color="#4078E0">发 布</a></td> 
                </tr>
           ...
           <%         }
                ...
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="8" align="center">
                    <input type="submit" name="Submit4" value="新 建">
                    <img src="../../images/space.gif" width="100" height="1"> 
                    <input type="submit" name="Submit5" value="返 回" onClick="javascript:window.history.go(-1)">
                  </td>
                </tr>
              </table>
            </td>
