...
<jsp:setProperty name="PostingPagePara" property="buyFlag" value="B" />
...
<% if ( !(UserInfo.getApproved().equals("Y")) 
	...
	<jsp:forward page="inform.jsp?info=很抱歉,您未被授权进行需求发布!" />
	</jsp:forward>
<% }%>
    ...
    <td valign="top"><!-- #BeginEditable "body" -->
        ...
        <table width="600" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#CCCCFF">
          <tr bordercolor="#FFFFFF"> 
            ...
            <form name="mainListForm" method="post" action="request2buy.jsp">
                <tr> 
...
<input type="HIDDEN" name="bid_destCityId_h" value=>
		    ...
		    <%}%>
                ...
                <tr valign="top"> 
                  <td colspan="3" bgcolor="#E6EDFB"> 
                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><img src="../../images/requirements.gif" width="127" height="26"></td>
                      </tr>
                      <tr>
                        <td>
				...
				<%}%>
                                ...
                                <input type="HIDDEN" name="bid_price" value="0">
                              </td>
                            </tr>
                            <tr bgcolor="#E6EDFB"> 
...
selectList(mainInputForm.prodStateId, mainInputForm.prodStateId_h.value);
...
selectList(mainInputForm.prodCityId, mainInputForm.prodCityId_h.value);
recreateList2(mainInputForm.bid_destStateId, stateArray, mainInputForm.langCode.value=="EN"?"2":"1");
selectList(mainInputForm.bid_destStateId, mainInputForm.bid_destStateId_h.value);
...
selectList(mainInputForm.bid_destCityId, mainInputForm.bid_destCityId_h.value);
