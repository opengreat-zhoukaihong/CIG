...
<% if ( !(UserInfo.getBuySaleFlag().equals("S"))){%>
	<jsp:forward page="inform.jsp?info=很抱歉,您不是销售方!" />
	</jsp:forward>
<% }%>

<% if ( !(UserInfo.getApproved().equals("Y"))){%>
	<jsp:forward page="inform.jsp?info=很抱歉,您暂未被核准!" />
	</jsp:forward>
<% }%>
          ...
          <tr bordercolor="#FFFFFF"> 
            <td > 
              <table width="600" border="0" cellspacing="0" cellpadding="2" bgcolor="#E6EDFB">
                <tr> 
                  <td colspan="3" height="25" bgcolor="#4078E0"><font color="#FFFFFF" class="big"><b>产品资料维护 
                    </b> </font></td>
                </tr>
                <tr> 
		...
		<input type="HIDDEN" name="productId" value="<%=ProdInfoPagePara.productId%>">
                <tr> 
                  <td width="184" align="center" class="dan10"> 
                    <select name="list1" size="7" class="list2" ONCHANGE=<%if (!editPage){%>"ChangeProduct();"<%}else{%>"javascript: alert('不可更改!'); selectProduct(document.mainInputForm.cateId.value);" <%}%>>
                      <option>个人产品规格</option>
                    </select>
                  </td>
                  <td width="184" align="center" class="dan10"> 
                    <select name="list2" size="7" class="list2" ONCHANGE=<%if (!editPage){%>"recreateGrades();"<%}else{%>"javascript: alert('不可更改!'); selectPaperType(document.mainInputForm.typeId.value);" <%}%>>
                      <option>个人产品规格</option>
                    </select>
                  </td>
                  <td width="184" align="center" class="dan10"> 
                    <select name="list3" size="7" class="list2" ONCHANGE=<%if (editPage){%>"javascript: alert('不可更改!'); selectGrade(document.mainInputForm.gradeId.value);" <%}%>>
                      <option>个人产品规格</option>
                    </select>
                  </td>
                </tr>
