...
<jsp:setProperty name="CateList" property="langCode" value="GB" />
<jsp:setProperty name="CateList" property="classFlag" value="C" />
...
<table width="776" border="0" cellspacing="0" cellpadding="0" height="600">
  <tr>
    <td width="159"> <script language="JavaScript" src="../../javascript/caidan.js">
</script>
    ...
    <td valign="top"><!-- #BeginEditable "body" -->
      ...
      <form  name="mainListForm" method="post" action="order_search.jsp">
                <tr bgcolor="#4078E0"> 
                  <td colspan="3" height="25"><font color="#FFFFFF" class="big"><b>供需检索</b></font></td>
                </tr>
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="1" class="big"> 
                  <% if (OrderSearchPagePara.buyFlag.equals("S")){%>
                    <input type="radio" name="buyFlag" value="S" checked><b>供应</b><img src="../../images/space.gif" width="50" height="1"> 
                    <input type="radio" name="buyFlag" value="B"><b>需求</b></td>
                  <% }else{ %>
                    <input type="radio" name="buyFlag" value="S"><b>供应</b><img src="../../images/space.gif" width="50" height="1"> 
                    <input type="radio" name="buyFlag" value="B" checked><b>需求</b></td>
                  <% }%>
                  <td colspan="2" class="dan10">按关键词 
                    <input type="text" name="keyWord" size="11" >
                    <input type="submit" name="Submit2" value="检 索" onClick="javascript:this.form.action='PostList.jsp';">
                  </td>
                </tr>
                <tr bgcolor="#4078E0"> 
                  <td align="center" width="194" class="dan10" height="18" bgcolor="#4078E0"><font color="#FFFFFF">类别</font></td>
                  <td align="center" width="154" class="dan10" height="18" bgcolor="#4078E0"><font color="#FFFFFF">产品</font></td>
                  <td align="center" width="197" class="dan10" height="18"><font color="#FFFFFF">型号</font></td>
                </tr>
                <tr bgcolor="#E6EDFB"> 
                  <td height="42" align="center" width="194" class="dan10"> 
                    <select name="list1" size="5" class="list2" ONCHANGE="ChangeProduct();">
                      <option>产品规格</option>
                    </select>
                  </td>
                  <td height="42" align="center" width="154" class="dan10"> 
                    <select name="list2" size="5" class="list2" ONCHANGE="recreateGrades();">
                      <option>产品规格</option>
                    </select>
                  </td>
                  <td height="42" align="center" width="197" class="dan10"> 
                    <select name="list3" size="5" class="list2">
                      <option>产品规格</option>
                    </select>
                  </td>
                </tr>
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="3" class="dan10"> <br>
                ...
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="3" class="dan10" align="center" height="40">点击指标名称，可以输入指标的取值范围。</td>
                </tr>
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="3"> 
...
<INPUT TYPE="HIDDEN" NAME="type_Spec" value="">
      		...
      		<form>
                <tr bgcolor="#E6EDFB"> 
                  <td colspan="3" class="dan10" align="center"> &nbsp;</td>
                </tr bgcolor="#E6EDFB">
                <tr> 
                  <td colspan="3" class="dan10" align="center"> 
                    <input type="button" name="Submit2" value="重 设" onClick="javascript:document.mainSpecForm.reset();">
                    <img src="../../images/space.gif" width="40" height="1"> 
                    <img src="../../images/space.gif" width="40" height="1"> 
                    <input type="button" name="Submit4" value="继 续" onClick="javascript:submitPage()">
                  </td>
                </tr>
	        </form>
              </table>
