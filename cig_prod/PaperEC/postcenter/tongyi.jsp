...
<table width="776" border="0" cellspacing="0" cellpadding="0" height="600">
  <tr> 
    ...
    <td valign="top"><!-- #BeginEditable "body" --><br>
          ...
          <tr bordercolor="#FFFFFF"> 
            <td>             
              <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#E6EDFB" height="400">
               ...
               <%
                  if(bool.equals("Y")){
                     reco="很抱歉！您已经对该定单签定了合同。";
               %>
                 <td height="362" align="center"><%=reco%></td>
                <tr align="center"> 
                 <td>
                 <input type="button" name="Submit0" value="返  回" onClick="reload(1);">
                 </td>
                </tr> 
               <%
                  }else{
               ...
               <%
                   if(act.equals("ty")&&i!=10) {
                      reco="恭喜你们，在供应发布ID#"+posting_id+"  bid ID#"+bid_id+" 产品上达成了一致，并签定了电子合同。"+
                               "本网数据库记录了你们的电子签名和时间。随后，为慎重起见，我们会给你们"+
                               "双方各寄两份文本合同，请签字盖章后寄回本网。我们会将有你们买卖双方共"+
                               "同签名的合同再寄回一份给你们。";
               %> 
                  <td height="362" align="center"><%=reco%></td>
                <%
                     }else if(act.equals("ty")&&i==10){
                          reco="很抱歉！合同未签定成功，请稍后再试。";
                %>
                  <td height="362" align="center"><%=reco%></td> 
                <%
                     }else{
                %>  
                 <td height="362" align="center"> <textarea name="textfield" cols="70" rows="20">
                 <%=prov.getContent()%>
                 </textarea>
                 </td>
                <%
                ...
                <tr align="center"> 
                  ...
                  <%
                   if(act.equals("ty")) {
                  %> 
                    <input type="button" name="Submit0" value="返  回" onClick="reload(2);">
                  <%
                      }else{
                  %>
                    ...
                    <input type="submit" name="Submit2" value="同  意">
                  <%
                      }   } 
                  %>
                  </td>
