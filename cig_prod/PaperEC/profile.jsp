...
<%  String str[]=new String[14];
   ...
   <jsp:setProperty name="myFind" property="sqlStc" value="select name,country_id from country where lang_code='GB'" />
   <% try{    
             String sele="";String pub="";String pubc="";
             ...
             allData=myFind.getAllData();
              ...
              while(allData.next()){                
               ...
               v_id.addElement(st);
               st="select name,state_id from state where lang_code='GB' and country_id="+st;
               ...
               while(stateData.next()){
                  ...
                  st="select name,city_id from city where lang_code='GB' and state_id="+st;
           ...
           String stri="select code,str_value from parameter where id=7 and lang_code='GB'";
           ...
           myFind.disconn();
            stri="select code,str_value from parameter where id=11 and lang_code='GB'";
           myFind.setSqlStc(stri);
           allData=myFind.getAllData();
           while(allData.next()){
          ...
          <tr bordercolor="#FFFFFF"> 
            <td height="195"> 
              <table width="500" border="0" cellspacing="0" cellpadding="0">
                <tr bgcolor="#4078E0"> 
                  <td height="25"><font color="#FFFFFF">个人资料</font></td>
                </tr>
                <tr> 
                  <td> 
                    <table width="500" border="0" cellspacing="1" cellpadding="4">
                     ...
                     %> 
                      ...
                      <tr> 
                        <td width="104" align="center" height="25" class="dan10">工作职称：</td>
                        <td width="251" bgcolor="#E6EDFB" class="dan10"> 
