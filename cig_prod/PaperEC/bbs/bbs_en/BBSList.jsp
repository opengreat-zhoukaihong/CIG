          ...
          <tr>
            <td>
              <table width="600" border="0" cellpadding="4" cellspacing="0" align="center">
                <tr> 
                <td height="25" bgcolor="#E6EDFB" class="font10">Total Postings: <font color="red"><%=bbsCount%></font>articles, <font color="red"><%=totalPage%></font><%if(totalPage>1){%>pages<%}else{%>page<%}%><img src="../../../images/images_en/space.gif" border="0"  width="200" height="1">page<font color="red"><%=pageno%></font>
                <a href="BBS_AddNew.jsp?cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>">New Posting</a>|<%if ((pageno == 1)&&(totalPage>1)){%><a href="BBSList.jsp?pageNo=2&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>">next</a>
              ...
              <a href="BBSList.jsp?pageNo=<%=pageno-1%>&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>">previous</a><%  }%>|<a href="BBSList.jsp?pageNo=1&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>">first</a> 
              </td>
              </tr>
              <tr> 
              <td> 
             ...
             <%}else{%><tr bgcolor="#D8E4F8"> 
              <td width="285"><%}%>
              <a href="BBS_ViewDetail.jsp?cate_ID=<%=cate_ID%>&article_ID=<%=bbsLists[i][1]%>&area_ID=<%=area_ID%>" onClick="return zy_callpage(this.href);"><%=BBSList.makeUpStr(46,bbsLists[i][3])%></a></td>
             ...
             <tr align="center"> 
             <td><a href="BBS_AddNew.jsp?cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>"><img src="../../../images/images_en/faxtz.gif.gif" border="0"  width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0">
             <%if ((pageno == 1)&&(totalPage>1)){%><a href="BBSList.jsp?pageNo=2&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>"><img src="../../../images/images_en/next_page.gif.gif" border="0"  width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0">
             <%  }else if ((pageno>1)&&(pageno<totalPage)){%><a href="BBSList.jsp?pageNo=<%=pageno-1%>&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>"><img src="../../../images/images_en/last_page.gif.gif" border="0"  width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0">
             <a href="BBSList.jsp?pageNo=<%=pageno+1%>&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>"><img src="../../../images/images_en/next_page.gif.gif"  border="0" width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0">
             <%}else if ((pageno>1)&&(pageno==totalPage)){%>
             <a href="BBSList.jsp?pageNo=<%=pageno-1%>&cate_ID=<%=cate_ID%>&area_ID=<%=area_ID%>"><img src="../../../images/images_en/last_page.gif.gif"  border="0" width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0">
             </td>
             </tr>
            <%
             }
