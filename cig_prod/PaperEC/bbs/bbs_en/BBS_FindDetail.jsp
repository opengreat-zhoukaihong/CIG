          ...
          <tr>
            <td>
              ...
              <%for(int i=0;i<articleCount;i++){
                %>
              <tr> 
                  <td width="108" height="28">Name,Time：</td>
                ...
                <tr> 
                  <td width="108">&nbsp;</td>
                  <td width="414" align="right"><a href="BBS_FindDetail.jsp?cate_ID=<%=articleLists[i][6]%>&article_ID=<%=articleLists[i][1]%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>">revert</a></td>
                </tr>
                <tr> 
                  <td colspan="2">
                    <hr>
              ...
              <table width="550" border="0" cellspacing="0" cellpadding="4" bgcolor="#D8E4F8">
                ...
                <tr> 
                  <td>title:</td>
                  <td> 
                    <input type="text" size="60" name="titles1" value="Re:<%=articleLists[0][2]%>">
                  </td>
                </tr>
                <tr> 
              ...
              <tr align="center"><td><input type="submit" value="revert"   style="width:65px" name="submit"></td><td><img src="../../../images/images_en/space.gif" border="0"  width="50" height="1"></td>
              <td><input type="reset" value="cancel"   style="width:65px"  name="button"></td>
              <!--<td><img src="../../../images/images_en/fabubbs.gif.gif" border="0" width="60" height="22"><img src="../../../images/images_en/space.gif" border="0"  width="50" height="1"><img src="../../../images/images_en/qingc.gif.gif" border="0" width="60" height="22"></td>
              -->
                </tr>
              </table>
            </td>
