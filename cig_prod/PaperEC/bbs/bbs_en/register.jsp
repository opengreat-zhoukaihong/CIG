...
function validateIntValue(numv){
       ...
       if(len<6||len>16){
          alert("This is invalid,please reinput using suitable length!");
          numv.value='';
          return false;
       }
       for(var i=0;i<len;i++){
...
function validateForm(e){
    ...
    if(e.p_dept.value==''){
	alert('Please input your department£¬afterwards submit!')
	e.p_dept.focus()
	return false;
    }
    if(e.p_job_title.value==''){
	alert('Please input your job title£¬afterwards submit!')
	e.p_job_title.focus()
	return false;
    }  
    if(e.p_login.value==''){
...
function validateall(ex) {
   switch(ex){     
      ...
      if( putin.p_mobile.value.length<11 ){
         ...
         alert("Phone code error£¬please validate and input again!")
            return false;
      }
      break;    
      ...
      <form method="post" action="revert.jsp" name="putin" onSubmit="return validateForm(putin);">
        <table width="604" border="0" cellspacing="0" cellpadding="4" bgcolor="#E6EDFB">
            ...
            <td> 
              <table width="604" border="0" cellspacing="0" cellpadding="4">
                <tr> 
                  ...
                  <td width="322"><font color="#FF3300">*</font>(Usernames must 
                    be between 6 and 16 alphanumeric characters, and are case 
                    sensitive.) </td>
                </tr>
                <tr> 
                  ...
                  <td width="322"><font color="#FF3300">*</font>(Passwords must 
                    be between 6 and 16 alphanumeric characters, and are case 
                    sensitive.) </td>
                </tr>
                <tr> 
                  ...
                  <td width="322" height="35"> <font color="#FF3300">*</font></td>
                </tr>
                <tr> 
            ...
            <td height="213"> 
              <table width="604" border="0" cellspacing="0" cellpadding="4">
                ...
                <tr> 
                 ...
                 <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=11 and lang_code='EN'" /> 
          <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
          ...
          %>  
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=8 and lang_code='EN'" /> 
                  <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
              ...
              while(arr[i]!=null){
                ...
                <tr> 
                  ...
                  <td colspan="2"> <font color="#FF3300"> 
                    ...
                    *</font>(Such as 86-755-3691610)</td>
                </tr>
                <tr> 
                  <td width="117">Fax:</td>
                  <td colspan="2"> <font color="#FF3300"> 
                    <input type="text" name="p_fax_c" >
                    *</font>(Such as 86-755-3201877)</td>
                </tr>
                <tr> 
          ...
          <tr> 
            <td> 
              <table width="604" border="0" cellspacing="0" cellpadding="4">
                ...
                <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=9 and lang_code='EN'" /> 
          <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
            ...
            %> 
              ...
              while(arr[i]!=null){
                 ...
                 <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=10 and lang_code='EN'" /> 
         <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
          ...
          <tr> 
           ...
           <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=3 and lang_code='EN'" /> 
          <%     
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
          ...
          <jsp:setProperty name="myFind" property="sqlStc" value="select code,str_value from parameter where id=5 and lang_code='EN'" /> 
          <%    
             allData=myFind.getAllData();
             for(i=0;i<30;i++)
             if(allData.next()){                
