...
<table width="776" border="0" cellspacing="0" cellpadding="0" height="600"><tr>
  ...
  <table width="500" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#4078E0">
    <tr bgcolor="#4078E0"> 
      <td> 
        <div align="right"><font color="#FFFFFF" class="font9">个人信息中心</font></div>
      </td>
    </tr>
    <tr> 
      <td class="font10"><b>主　　题：</b><%= MessageDetail.getMessageTitle() %></td>
    </tr>
    <tr> 
      <td class="font10"><b>发送时间：</b><%= MessageDetail.getMessageTime() %></td>
    </tr>
    <tr> 
      <td><span class="font9"><span class="font9"><span class="font10"><b>内　　容：</b><br>
        <textarea name="textfield" cols="70" rows="18"><%= MessageDetail.getMessageDetail() %>
            </textarea>
