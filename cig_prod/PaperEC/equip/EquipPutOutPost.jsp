...
tmp="需求";
String title="发布"+tmp+"信息";
if(Equip_Art.InsertDates()){
 	info += "您的信息已成功加入到"+tmp+"信息列表！<br>";
    }
else{
	info +="很抱歉,未能成功，请检查数据!";
}
response.sendRedirect("success.jsp?title="+URLEncoder.encode(title)+"&info="+URLEncoder.encode(info)+"&art_Type="+art_Type+"&type_ID="+type_ID+"&queryString="+queryString+"&queryString2="+queryString2);
%>
<%--
<html>
<head>
