          ...
          <tr> 
            <td > 
              <table width="141" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#000000" bordercolordark="#cccccc" bordercolor="#000000">
                ...
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryID=0&queryString2=<%=queryString2%>"><font color="#FFFFFF">浏览供应信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,0)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryID=1&queryString2=<%=queryString2%>"><font color="#FFFFFF">浏览需求信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,1)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryID=2&queryString2=<%=queryString2%>"><font color="#FFFFFF">发布供应信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,2)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=2*count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryID=3&queryString2=<%=queryString2%>"><font color="#FFFFFF">发布需求信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,3)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipPutOut.jsp?art_Type=<%=art_Type%>&type_ID=<%=type_ID%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=3*count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <tr> 
                  <td>
                    <table width="600" border="0" cellspacing="1" cellpadding="4">
                      ...
                      <tr bgcolor="#B0C8F0"> 
                        <td width="123" bgcolor="#B0C8F0">生产厂商：</td>
                        <td width="154"> 
                      ...
                      <tr bgcolor="#D8E4F8"> 
                        <td width="123" bgcolor="#D8E4F8">设备所在地：</td>
                        <td width="154"> 
                          <input type="text" name="machine_Loca">
                        </td>
                        <td width="94">设备目前状态：</td>
                        <td width="188"> 
                      ...
                      <tr bgcolor="#B0C8F0"> 
                        <td width="123" bgcolor="#B0C8F0"><font color="#990033">信息有效期（天）：</font></td>
                        <td width="154"> 
                      ...
                      <%}else{%>
                      <tr bgcolor="#B0C8F0"> 
                        <td width="123">求购价格：</td>
                        <td width="154"> 
                          <input type="text" name="price">
                        </td>
                        <td width="94"><font color="#990033">信息有效期：<br>
                          （天）</font></td>
                        <td width="188"> 
                          <input type="text" name="vali_Date">
                        </td>
