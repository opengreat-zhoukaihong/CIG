...
function launchRemote(url) {
      var newin=open(url, "pick", 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=556,height=302');
	newin.focus();
        return false;
}
//-->
          ...
          <tr> 
            <td> 
              <table width="141" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#000000" bordercolordark="#cccccc" bordercolor="#000000">
                ...
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryID=0&queryString2=<%=queryString2%>"><font color="#FFFFFF">浏览供应信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,0)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryID=1&queryString2=<%=queryString2%>"><font color="#FFFFFF">浏览需求信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,1)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryID=2&queryString2=<%=queryString2%>"><font color="#FFFFFF">发布供应信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,2)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=2*count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
                ...
                <%}%>
                <tr bgcolor="#4078E0"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryID=3&queryString2=<%=queryString2%>"><font color="#FFFFFF">发布需求信息</font></a></td>
                </tr>
                <%if(Equip_Cate.JudgeBit(queryString,3)){%>
                <%for(int i=0;i<count;i++){%>
                <tr bgcolor="#E8AE00"> 
                  <td height="22" width="142" align="center"><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageNo%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>&queryID2=<%=3*count+i%>"><b><%=lists[i][1]%></b></a></td>
                </tr>
          ...
          <tr>
            <td>
              <table width="600" border="0" cellspacing="0" cellpadding="4" bgcolor="#E6EDFB">
                <tr>
                 <td class="title" colspan="2"><b>专业设备--全部
                </b></td>
                </tr>
                <tr>
                  <td colspan="2"> ---- 查找信息列表</td>
                </tr>
                <tr>
                  <td colspan="2">
                    <hr>
                ...
                %>
                <tr align="center"> 
                  <td colspan="2">共查找到<%=artCount%>条的信息。（请点击详细内容查看）</td>
                </tr>
                <tr>
               <form method="post" name="toPage" action="EquipFindList.jsp" onSubmit="return validateForm(toPage);">
               ...
               <input type=hidden name="keyword" value="<%=keyword%>" >
                  <td>当前显示<%=current%>-<%=toTail%>条（倒序显示）</td><td align="right" nowrap>
                    ...
                    <%if((totalPage>1)&&(pageno<totalPage)){%><a href="EquipFindList.jsp?keyword=<%=keyword%>&pageNo=<%=pageno+1%>&queryString=<%=queryString%>&queryString2=<%=queryString2%>">下一页</a><%}%></td>
                </form>
               </tr>
               <tr>
                  <td colspan="2">
                ...
                <tr align="right">
                <form method="post" name="toPage2" action="EquipFindList.jsp" onSubmit="return validateForm(toPage2);">
                <input type=hidden name="queryString" value="<%=queryString%>" >
                <input type=hidden name="queryString2" value="<%=queryString2%>" >
                <input type=hidden name="keyword" value="<%=keyword%>" >
