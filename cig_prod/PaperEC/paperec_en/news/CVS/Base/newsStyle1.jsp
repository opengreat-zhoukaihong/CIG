...
<table width="80%" border="0" cellspacing="0" cellpadding="6" align="center">
  <tr> 
    <td class="font5b" align="center" height="36"><%= News.getNewsTitle() %><br>
      <span class="font2"><%= News.getNewsSubTitle() %> </span></td>
  </tr>
  <tr> 
    <td class="font2">
      <table width="30%" border="0" cellspacing="6" cellpadding="0" align="left">
        <tr align="center"> 
      ...
      <img src="../../../images/images_en/space.gif" width="24" height="1">
      <%= News.getNewsDetail() %></td>
  </tr>
</table>
