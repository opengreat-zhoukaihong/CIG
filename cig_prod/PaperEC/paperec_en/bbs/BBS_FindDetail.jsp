          ...
          <tr>
            <td>
              ...
              <tr> 
                ...
                <tr> 
                  <td width="108" height="32"> Title £º</td>
                ...
                <tr> 
                  <td width="108">&nbsp;</td>
                  <td width="414" align="right"><a href="javascript:window.close();">Close</a>|<a href="BBS_FindDetail.jsp?cate_ID=<%=articleLists[i][6]%>&article_ID=<%=articleLists[i][1]%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>">Reply</a></td>
                </tr>
                <tr> 
                  <td colspan="2">
                    <hr>
              ...
              <table width="550" border="0" cellspacing="0" cellpadding="4" bgcolor="#D8E4F8">
                ...
                <tr> 
                  <td>title:</td>
                  <td> 
                    <input type="text" name="titles1" value="Re:<%=articleLists[0][2]%>">
                  </td>
                </tr>
                <tr> 
