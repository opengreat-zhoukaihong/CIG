...
function validateForm(e){
	...
	if(e.titles1.value==''){
	 alert('Please enter title ,then submit!')
	e.titles1.focus()
	return false;
	}
	if(e.email.value==''){
...
<table width="776" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="159" height="394"> 
      ...
      <div style="position:absolute; width:141px; height:131px; z-index:1; left: 2px; top: 1px" id="scrollMenu" class="algin"> 
                ...
                <tr align="center" bgcolor="#FFCC33"> 
                 <form method="post" action="BBS_Find.jsp">
                  ...
                  <input type="hidden" name="pageNo"  value="1">
                    <td height="76"  width="139" class="b9"><%if(area_ID.trim().equals("3")){%>&nbsp;Title&nbsp;&nbsp;:<%}else{%>Keyword:<%}%><input type="text" name="titles" accesskey="a" size="8" class="textfield"><br>&nbsp;Name&nbsp;&nbsp;:<input type="text" name="userName" accesskey="a" size="8" class="textfield"><br><input type="submit" name="Submit" value="search"></td></form>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table width="550" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF">
          <tr>
            <td> 
              ...
              <tr align="center"><td><input type="submit" value="submit"   style="width:65px" name="submit"></td><td><img src="../../../images/images_en/space.gif" border="0"  width="50" height="1"></td>
