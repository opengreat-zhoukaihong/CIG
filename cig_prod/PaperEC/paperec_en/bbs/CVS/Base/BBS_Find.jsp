...
%> <jsp:useBean id="BBS_Find" scope="page" class="bbs.BBS_Find" /> <jsp:setProperty name="BBS_Find" property="pageFlag" value="Y"/> 
<jsp:setProperty name="BBS_Find" property="restriction" value="15"/> <jsp:setProperty name="BBS_Find" property="dateFrom" /> 
<jsp:setProperty name="BBS_Find" property="dateTo" /> <jsp:setProperty name="BBS_Find" property="keyWord" /> 
          ...
          <tr> 
            <td> 
              <table width="600" border="0" cellpadding="4" cellspacing="0" align="center">
                <tr> 
                  <td height="25" bgcolor="#E6EDFB" class="font10">Total Postings: 
                    ...
                    <font color="red"><%=totalPage%></font> <%if(totalPage>1){%>Pages<%}else{%>Page<%}%><img src="../../../images/images_en/space.gif" border="0"  width="260" height="1">Page<font color="red"><%=pageno%></font> 
                    ...
                    <%}else if ((pageno>1)&&(pageno==totalPage)){%> <a href="BBS_Find.jsp?pageNo=<%=pageno-1%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>">Previous</a><%  }%>|<a href="BBS_Find.jsp?pageNo=1&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>">First</a> 
                  </td>
                </tr>
                <tr> 
                  <td> 
              ...
              %> 
                      ...
                      <tr bgcolor="#D8E4F8"> 
                        <td width="285"><%}%> <a href="BBS_FindDetail.jsp?cate_ID=<%=bbsLists[i][8]%>&article_ID=<%=bbsLists[i][1]%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>" onClick="return zy_callpage(this.href);"><%=BBS_Find.makeUpStr(46,bbsLists[i][3])%></a></td>
             ...
             %> 
                ...
                <tr align="center"> 
                  <td><%if ((pageno == 1)&&(totalPage>1)){%><a href="BBS_Find.jsp?pageNo=2&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>"><img src="../../../images/images_en/next_page.gif" border="0" width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0"> 
                    <%  }else if ((pageno>1)&&(pageno<totalPage)){%><a href="BBS_Find.jsp?pageNo=<%=pageno-1%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>"><img src="../../../images/images_en/last_page.gif" border="0"  width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0"> 
                    <a href="BBS_Find.jsp?pageNo=<%=pageno+1%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>"><img src="../../../images/images_en/next_page.gif"  border="0" width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0"> 
                    <%}else if ((pageno>1)&&(pageno==totalPage)){%> <a href="BBS_Find.jsp?pageNo=<%=pageno-1%>&area_ID=<%=area_ID%>&titles=<%=URLEncoder.encode(findTitle)%>&userName=<%=URLEncoder.encode(userName)%>"><img src="../../../images/images_en/last_page.gif" border="0" width="60" height="22"></a><img src="../../../images/images_en/space.gif" width="33" height="1" border="0"> 
                  </td>
                </tr>
                <%}%> 
