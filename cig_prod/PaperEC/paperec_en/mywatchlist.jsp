...
function confirmDelete(){
    ...
    return confirm("Are you sure to delete it from your watchlist?")
...
<jsp:setProperty name="WatchList" property="userId"/> <jsp:setProperty name="WatchList" property="langCode" value="EN"/> 
          ...
          <tr bordercolor="#FFFFFF"> 
            <td height="165"> 
              <table width="600" border="0" cellspacing="2" cellpadding="4">
                <tr bgcolor="#4078E0"> 
                  <td colspan="6" height="25"><font color="#FFFFFF" class="big"><b>My 
                    Watchlist</b></font></td>
                </tr>
                <tr> 
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="105">Posting 
                    ID</td>
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="155">Description</td>
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="135">Expiration 
                    Date</td>
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="62">Quantity</td>
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="87">Status</td>
                  <td class="dan10" bgcolor="#7EA2EB" align="center" width="87">&nbsp;</td>
                </tr>
                <% if (watchListCount==0){%> 
                <tr> 
                  <td colspan="6" align="center" bgcolor="#3F78DD" height="22"><font color="#FFFFFF" class="white10">Sorry,there 
                    are no postings in your Watchlist！</font></td>
                </tr>
                <% }else{ 
              ...
              %> 
                <tr> 
                  ...
                  <td class="dan10" bgcolor="#E6EDFB" align="center" width="87"><a href="mywatchlist.jsp?user_id=<%=UserInfo.getUserId()%>&action=1&postingId=<%=watchList[i][0]%>" ONCLICK="return confirmDelete()"><font color="#3333FF">Delete 
                    </font></a> </td>
                </tr>
                <%    }
                 } 
	      %> 
                <tr bgcolor="#E6EDFB"> 
                  <td align="center" height="25" colspan="6" class="dan10"> 
                    ...
                    <input type="submit" name="Submit2" value="Back" onClick="javascript:window.history.go(-1)">
                  </td>
                </tr>
              </table>
            </td>
