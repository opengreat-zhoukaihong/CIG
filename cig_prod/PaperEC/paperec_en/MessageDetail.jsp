...
<jsp:useBean id="MessageDetail" scope="page" class="mypaperec.MessageDetail" /> 
<jsp:setProperty name="MessageDetail" property="messId" /> <%  if (!UserInfo.getAuthorized()){
%> <jsp:forward page="notAuthorized.jsp" /> </jsp:forward> <%    }
%> <% MessageDetail.fetchMessage(); %> 
<table width="776" border="0" cellspacing="0" cellpadding="0" height="600"><tr>
  ...
  <table width="500" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#4078E0">
    <tr bgcolor="#4078E0"> 
          <td> 
            <div align="left"><font color="#FFFFFF" class="font9"><b>Message Center</b></font></div>
          </td>
    </tr>
    <tr> 
      <td class="font10"><b>Title£º</b><%= MessageDetail.getMessageTitle() %></td>
    </tr>
    <tr> 
      <td class="font10"><b>Time£º</b><%= MessageDetail.getMessageTime() %></td>
    </tr>
    <tr> 
      <td><span class="font9"><span class="font9"><span class="font10"><b>Content:</b><br>
        <textarea name="textfield" cols="70" rows="18">
            <%= MessageDetail.getMessageDetail() %>
            </textarea>
        </span></span><span class="font10"> </span></span></td>
    </tr>
    <tr align="center"> 
      <td height="25"> 
