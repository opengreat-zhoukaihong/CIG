...
<% if ( !(UserInfo.getApproved().equals("Y")) 
	...
	<jsp:forward page="inform.jsp?info=Sorry, you are unable to post a request to buy. You must first become a Verified Member!" />
	</jsp:forward>
<% }%>
          ...
          <tr bordercolor="#FFFFFF"> 
            <td > 
              <table width="600" border="0" cellspacing="0" cellpadding="2" bgcolor="#E6EDFB">
                <tr> 
                  <td colspan="2" height="25" bgcolor="#4078E0"><font color="#FFFFFF" class="big"><b>Request to Buy 
                    </b> </font></td>
                </tr>
            <form name="mainListForm" method="post" action="request2buy.jsp">
                ...
                <tr> 
                  <td colspan="2" align="center" class="dan10"> 
                    <select name="list1" size="7" class="list1" ONCHANGE="ChangeProduct();">
                ...
                <tr> 
                  <td width="184" align="center" class="dan10"> 
                    <select name="list2" size="7" class="list1" ONCHANGE="recreateGrades();">
                      <option>Product Specification</option>
                    </select>
                  </td>
                  <td width="184" align="center" class="dan10"> 
                    <select name="list3" size="7" class="list1">
                      <option>Product Specification</option>
                    </select>
                  </td>
                </tr>
...
<input type="HIDDEN" name="bid_destCityId_h" value=>
		    ...
		    <%}%>
                ...
                <tr valign="top"> 
                  <td colspan="2" bgcolor="#E6EDFB"> 
                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><img src="../../../images/images_en/requirements.gif" width="127" height="26"></td>
                      </tr>
                      <tr>
                        <td>
