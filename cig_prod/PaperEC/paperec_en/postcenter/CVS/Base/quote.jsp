...
<a name="top"></a> 
		...
		<input type="HIDDEN" name="langCode" value="EN"> 
                  ...
                  <td colspan="3" bgcolor="#E6EDFB"> 
                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
               <%   if(bors.equals("B")){      %>       
                        <td><img src="../../../images/images_en/bidding_info.gif" width="127" height="26"></td>
               <%   }else{              %>     
                        <td><img src="../../../images/images_en/offer_info.gif" width="127" height="26"></td>
               <%   }  %>       </tr>
                      <tr>
                      <tr>
                        <td>
                          <table width="600" border="1" cellspacing="0" cellpadding="2" bordercolorlight="#000000" bordercolordark="#E6EDFB" align="left">
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22">Quantity： 
                                <input type="text" name="bid_quantity" size="12" onBlur="validField(this);" value=<%=st[0]%>>
                                Unit： <%=st[1]%>
				<input type="HIDDEN" name="bid_unit" value="<%=st[1]%>"> 
                              </td>
                            </tr>
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22">
                                Currency： <%=st[3]%>
				<input type="HIDDEN" name="bid_currency" value="<%=st[3]%>"> 
                                Offer： 
                                <input type="text" name="bid_price" size="12" onBlur="validField(this);" value=<%=st[2]%>>
                              </td>
                            </tr>
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22">Terms of Price： 
		...
		<% } %>
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22" bgcolor="#E6EDFB">Ship/Delivery Date：
		                <select name="dsd_y">
				  ...
				  <option value="01">01</option>
                            ...
                            <tr bgcolor="#E6EDFB"> 
                              <td class="dan10" height="22">Bid is Valid From： 
		                <select name="bt_y">
		                  <option value="2000">2000</option>
		                </select>
		                <select name="bt_m">
...
<%     }else{   
           ...
           float fla=Float.valueOf(arr[0]).floatValue()*Float.valueOf(arr[2]).floatValue(); 
            ...
            String serial="";
            if(str.equals("0")){
              str="System error,please try again for a moment！";
            }else{
              str="You have successed entered the bid ID#"+str+"";
          ...
          <tr bgcolor="#E6EDFB"> 
                ...
                <tr valign="top"> 
                  <td colspan="3" bgcolor="#E6EDFB"> 
                    <table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><img src="../../../images/images_en/keyijiaxx.gif" width="127" height="26">&nbsp;&nbsp;<%=str%></td>
                      </tr>
                      <tr>
                        <td>
                          <table width="600" border="1" cellspacing="0" cellpadding="2" bordercolorlight="#000000" bordercolordark="#E6EDFB" align="left">
                           <tr bgcolor="#E6EDFB">                               
                             <td class="dan10" height="22">  &nbsp;&nbsp; Quantity：<%=arr[0]%> &nbsp;&nbsp;  Unit：                          
				        ...
				        <%    }}    %>
                              ...
                              <td class="dan10" height="22">Quote：<%=arr[2]%>  &nbsp;&nbsp;  Currency：                                
	 ...
	 <%   if(arr[4].equals("CFR")||arr[4].equals("CIF")){      %>	
             ...
             <%       }      %>
				...
				<%   }   }  }%>          
                        ...
                        <tr bgcolor="#E6EDFB">                                                    
                              <td class="dan10" height="22" >&nbsp; &nbsp;Become Effective Date：<%=arr[11]%>                                
                              &nbsp; &nbsp; &nbsp; &nbsp;
                              Expire Date：<%=arr[12]%>                                
                              </td>
                               <td class="dan10" height="22" >Ship/Delivery Date：<%=arr[13]%>                                
                              </td>   
                            </tr>
