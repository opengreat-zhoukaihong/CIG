...
<% 
	...
	info = "You have successfully submitted your product(s). PaperEC.com may " +
	       "need to check and verify the product(s) you wish to provide. Your " +
	       "company may be required to provide PaperEC with samples of the " +
	       "products you wish to sell online. (PaperEC stores and numbers the " +
	       "samples provided by suppliers in advance, so as to later PaperEC can " + 
	       "provide them to buyers as they are requested.) Shortly after this " +
	       "work is done, you will receive an Email notifying you that you can " +
	       "sell your product(s) on PaperEC.com. ";
    }else
    {
