          ...
          <td> 
            <table width="600" border="1" cellspacing="0" cellpadding="2" bordercolorlight="#000000" bordercolordark="#E6EDFB" align="left">
              <tr bgcolor="#E6EDFB"> <% if(lang.equals("modi")){      %> 
                <td class="dan10" height="22"> Quantity£º<%=str[6]%> </td>
                <%  }else{      %> 
                <td class="dan10" height="22"> Quantity£º 
                  <input type="text" name="number" size="12" onBlur="validField(this)" value=<%=str[6]%> >
                  &nbsp;&nbsp;<%=str[7]%> </td>
                <%      }       %> 
                <td class="dan10" height="22"> Offer£º<%=str[9]%> <%=str[8]%>/<%=str[7]%> 
                </td>
              </tr>
              <tr bgcolor="#E6EDFB"> 
                <td class="dan10" height="22" >Terms of Price£º<%=str[10]%> </td>
                <td class="dan10" height="22">Port/Location£º<%=str[11]%> </td>
              </tr>
              <tr bgcolor="#E6EDFB"> 
                <td class="dan10" height="22">Terms of Payment£º<%=str[12]%> </td>
                <td class="dan10" height="22">Payment Term£º<%=str[13]%> </td>
              </tr>
              <tr bgcolor="#E6EDFB"> 
