...
<jsp:useBean id="SearchCondition" scope="session" class="postcenter.SearchCondition" /> 
<jsp:useBean id="PostList" scope="page" class="postcenter.PostList" />

<jsp:setProperty name="SearchCondition" property="userId" />
<jsp:setProperty name="SearchCondition" property="langCode" value="EN"/>
<jsp:setProperty name="SearchCondition" property="classFlag" value="E"/>
          ...
          <tr bordercolor="#FFFFFF"> 
            <td height="292"> 
              <table width="600" border="0" cellspacing="0" cellpadding="0">
                ...
                <td colspan="3" height="25" bgcolor="#4078E0"><font color="#FFFFFF" class="font9"><b>Search 
                  Results</b></font></td>
                </tr>
                <tr align="center"> 
                  <td bgcolor="#7EA2EB" height="22" class="dan10" width="154">Product:<%=SearchCondition.cateName%></td>
                  <td class="dan10" width="217" bgcolor="#7EA2EB">Type:<%=SearchCondition.typeName%></td>
                  <td class="dan10" width="295" bgcolor="#7EA2EB">Grade:<%=SearchCondition.gradeName%></td>           
		</tr>
		<%    
    		  Spec[] sp;
