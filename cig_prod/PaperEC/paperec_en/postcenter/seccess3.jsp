<%@ page language="java"  %>
<jsp:useBean id="succ" scope="page" class="postcenter.EnBargain" />
...
<%  
    ...
    String retu=succ.getChange(bid_own,bid_id,phase,acc_userid);
     String cont="";
    if(retu.equals("10"))cont="Sorry!system error,please try again for a moment.";
    if(retu.equals("11"))cont="Sorry, the bid is already completed.";
    if(retu.equals("12"))cont="Sorry, you are not able to accept the bid now. Please check  your bid status.";
    if(retu.equals("13"))cont="Sorry, you are not able to accept the bid now. Please check  your bid status.";
    if(retu.equals("21"))cont="You have accepted the supplier's bid. The supplier will be informed automatically of"+
                              "this through email. Once the seller has agreed to the deal, you will receive an email notification.";
    if(retu.equals("22"))cont="You have successfully re-confirmed the deal with the seller. Please pay attention"+
                              "to your bid's status. If the bid's status is \"Awaiting Contract\", you will"+
                              "see a \"Sign Contract\" button. Click this button to sign the required electronic"+ 
                              "contract with the seller.  ";    
    if(retu.equals("221")||retu.equals("222"))cont="  You have accepted the buyer's bid.  Shortly you will receive an email "+
                              "confirming this, and the buyer will also receive an email notification.  "+                                                          
                              "PaperEC.com will contact the buyer to discuss details on this transaction.  "+
                              "PaperEC can provide all the foreign trade services to the buyers in mainland  "+  
                              "China who do not have foreign trade rights authorized by government, or who "+
                              "just want assistance with the import process. (For details, see \"Services\" on "+                             
                              "the floating pilot panel.) "+
                              "\n\n  If the buyer confirms the trade and needs our importing services, "+
                              "you and the buyer will be required to sign an electronic contract "+
                              "online. (Please pay attention to your bid's status. If the bid's status is "+
                              "\"Awaiting Contract\", you will see a \"Sign Contract\" button.) "+
                              "Then, PaperEC's importer subsidiary will, according to the "+
                              "terms you and the buyer both have reached, assist in the import "+
                              "process. "+
                              "\n\n  If the buyer wishes to complete this trade directly with you, you "+
                              "and the buyer will be required to sign an electronic contract online. "+
                              "According to the Membership Agreement, you will be required to "+
                              "sign an agreement for paying PaperEC.com the Transaction Fee associated "+
                              "with this deal. ";
          ...
          <td height="172"> 
            <table width="300" border="0" cellspacing="0" cellpadding="0" align="left">
              ...
              <tr bgcolor="#4078E0" align="center"> 
                <td height="25"> 
                  <input type="submit" name="Submit2" value="Back" onclick="reload()">
                </td>
              </tr>
            </table>
          </td>
