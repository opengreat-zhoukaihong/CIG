...
<jsp:setProperty name="Activity" property="userId" value="1"/> <jsp:setProperty name="Activity" property="langCode" value="EN"/> 
            ...
            <td height="172"> 
              <table width="400" border="0" cellspacing="0" cellpadding="0" align="left">
                <tr align="center" bgcolor="#E6EDFB"> <%if (result){%> 
                  <td class="font9" height="185">Your Workgroup has been successfully 
                    updated!</td>
                  <%}else{%> 
                  <td class="font9" height="185">Interal server error. Please 
                    retry in a moment!</td>
                  <%}%> </tr>
