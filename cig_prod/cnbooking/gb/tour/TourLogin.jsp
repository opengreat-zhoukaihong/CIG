...
<table width="500" border="0" cellspacing="0" cellpadding="0" height="24">
                <tr> 
                 ...
                 <td bgcolor="#FFBC04"> 
                    <div align="center"><font face="黑体" size="3"><a href="#<%=cityLists[i][0]%>">&nbsp;<%=cityLists[i][1]%>&nbsp;</a></font></div>
                  </td>
                 <%}%>
                </tr>
              </table>
          ...
          %>
          <tr> 
            <td height="22" bgcolor="<%=colors[i]%>"><a name="<%=cityLists[i][0]%>"></a><font face="黑体" size="3">&nbsp;<%=cityLists[i][1]%></font></td>
          </tr>
          <tr> 
            <td> 
          ...
          <tr> 
            <td> 
              <div align="center"><a href="#top">返回上一级</a></div>
            </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
