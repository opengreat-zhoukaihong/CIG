...
<!--//
 var prices = new Array ("<%=TourViewDetail.getPrice0()%>", "<%=TourViewDetail.getPrice1()%>", "<%=TourViewDetail.getPrice2()%>", "<%=TourViewDetail.getPrice3()%>", "<%=TourViewDetail.getPrice4()%>", "<%=TourViewDetail.getPrice5()%>", "<%=TourViewDetail.getPrice6()%>");
        ...
        var weekds,date1,k
          ...
          if(k==0){k="日";}
          window.alert("请注意, 出发日是星期"+k+",没有开班! ");
          return false;
        }
	...
	function DateSubmit_Check()
	{
	     ...
	     {
				window.alert("对不起, "+document.frmPost.d_Year.options[document.frmPost.d_Year.selectedIndex].value+"-"+document.frmPost.d_Month.options[document.frmPost.d_Month.selectedIndex].value+"-"+document.frmPost.d_Day.options[document.frmPost.d_Day.selectedIndex].value+" 这一天不存在, 请检查出发日期 !");
                      ...
                      <tr> 
                        <td colspan="2"> 
                          <table width="358" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF">
                            ...
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">出发人数：</font></div>
                              </td>
                              <td height="26" width="75%">
                            ...
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">出发日期：</font></div>
                              </td>
                              <td height="26" width="75%">
                                <div align="center">
