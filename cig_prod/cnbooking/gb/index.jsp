...
quHotList.setRow(1);
String hotHotelName = quHotList.getFieldValue("city_name") + quHotList.getFieldValue("name");
...
popup = window.open('', 'popupnav', 'width=320,height=320,resizable=1,scrollbars=auto');
if (popup != null) {
if (popup.opener == null) {
popup.opener = self; 
}
popup.location.href = '../../gb/2001.htm';
}
// -->
</script>
<head>
...
for (int i = 1; i <= rowCount ; i++)
{
   ...
   if (!stateName.equals(quHotList.getFieldValue("state_name")))
   {
      ...
      strCity = strCity + "*-按城市名称搜索-|0|" + quHotList.getFieldValue("state_id");
   }
...
{
 // if(newparent=="-按省市名称搜索-" && childfields[0]!="-按城市名称搜索-")
...
function AllSearch()
{
document.myForm.stateId.options[document.myForm.stateId.selectedIndex].text="-按省市名称搜索-";
document.myForm.cityId.options[document.myForm.cityId.selectedIndex].text="-按城市名称搜索-";
document.myForm.starId.options[document.myForm.starId.selectedIndex].text="-按星级标准搜索-";
...
if(mystate=="-按省市名称搜索-" && mycity=="-按城市名称搜索-" && star=="-按星级标准搜索-" &&  validateSpaceField(hotel))
{
alert("请输入查询条件!");
}
else
...
<table width="665" border="0" cellspacing="0" cellpadding="0" align="center" height="34">
  ...
  <tr bgcolor="#CCCCCC"> 
    <td width="664" height="12"><a href="/cnbooking/big/index.jsp"><img src="../../images/big.gif" width="71" height="12" border="0"></a> 
      <a href="/cnbooking/en/index.jsp"><img src="../../images/en.gif" width="71" height="12" border="0"></a> 
    </td>
  </tr>
  <tr> 
    <td width="664" height="25"><img src="../../images/gb/top_bar.gif" width="664" height="25" usemap="#Map" border="0"><map name="Map"><area shape="rect" coords="292,5,356,18" href="../../gb/user_manual.htm"><area shape="rect" coords="364,5,428,18" href="../../gb/abouts.htm"><area shape="rect" coords="436,5,500,18" href="../../gb/jobs.htm"><area shape="rect" coords="507,5,571,18" href="../../gb/co-operation.htm"><area shape="rect" coords="579,5,643,18" href="../../gb/secrecy.htm"></map></td>
  </tr>
</table>
  ...
  <tr>
    <td width="155" height="313" valign="top">
            ...
            <table border="0" width="126" cellspacing="0" cellpadding="0" align="center">
              <form name="LoginForm" action="CnBookingLogin.jsp?answerInput=" method="POST">
                <tr align="center" bgcolor="#FFDA9D">
                  <td><span class="pt9">会员： </span>
                    <input type="text" name="username" size="9" style="font-family: 宋体; font-size: 9pt">
                  </td>
                </tr>
                <tr align="center" bgcolor="#FFDA9D">
                  <td><span class="pt9">密码： </span>
                    <input type="password" name="passwd" size="9" style="font-family: 宋体; font-size: 9pt">
                  </td>
                </tr>
                <tr bgcolor="#FFDA9D">
                  <td height="8" align="center"><a href="javascript:document.LoginForm.submit()"><font color="#000000"><span class="pt9">登录</span></font></a>
                    <span class="pt9"><a href="free_register.jsp"><font color="#000000">免费注册</font></a></span></td>
                </tr>
                <tr>
      ...
      <table width="155" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="126" height="89"> <a href="../../gb/hotel_whole_sale.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../images/gb/link_01b.gif',1)"><img src="../../images/gb/link_01a.gif" width="127" height="22" border="0" name="Image1"></a> 
            <a href="../../gb/hotel_boardinghouse_main.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../images/gb/link_02b.gif',1)"><img src="../../images/gb/link_02a.gif" width="127" height="22" border="0" name="Image2"></a> 
            <a href="tour/TourLogin.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../images/gb/link_03b.gif',1)"><img src="../../images/gb/link_03a.gif" width="127" height="22" border="0" name="Image3"></a> 
            <a href="../../gb/car.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../images/gb/link_04b.gif',1)"><img src="../../images/gb/link_04a.gif" width="127" height="22" border="0" name="Image4"></a> 
            <a href="../../gb/tour.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../images/gb/link_05b.gif',1)"><img src="../../images/gb/link_05a.gif" width="127" height="22" border="0" name="Image5"></a> 
            <a href="../../gb/golf.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../../images/gb/link_06b.gif',1)"><img src="../../images/gb/link_06a.gif" width="127" height="22" border="0" name="Image6"></a> 
            <a href="../../gb/translators.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','../../images/gb/link_07b.gif',1)"><img src="../../images/gb/link_07a.gif" width="127" height="22" border="0" name="Image7"></a> 
            <a href="flight/FlightLogin.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','../../images/gb/link_08b.gif',1)"><img src="../../images/gb/link_08a.gif" width="127" height="22" border="0" name="Image8"></a> 
            <a href="free_register.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','../../images/gb/link_09b.gif',1)"><img src="../../images/gb/link_09a.gif" width="127" height="22" border="0" name="Image9"></a> 
            <a href="news/tour_news.jsp?pageNo=1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','../../images/gb/link_10b.gif',1)"><img src="../../images/gb/link_10a.gif" width="127" height="22" border="0" name="Image10"></a></td>
          <td width="13" height="89">&nbsp;</td>
        </tr>
      </table>
      <table width="155" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="flight/FlightLogin.jsp"><img src="../../images/gb/air_logo.gif" width="155" height="108" border="0"></a></td>
        </tr>
      </table>
    </td>
    <td width="355" height="313" valign="top">
      <table width="355" border="0" cellspacing="0" cellpadding="0" height="55">
        <tr>
          <td>
            <div align="center"><img src="../../images/gb/super.gif" width="350" height="50"></div>
          </td>
        </tr>
      </table>
...
%> 
        <tr> 
          <td height=10 width="10" class="pt9"></td>
          <td valign=center width=210 class="pt9"><a href="hotel_detail.jsp?hotelId=<%=quHotList.getFieldValue("Hotel_id")%>"><font color="#FF8000"><%=quHotList.getFieldValue("city_name") + " " + quHotList.getFieldValue("name")%> 
            </font></a></td>
...
%></font></td>
          <td valign=center width=45 class="pt9"> 
            <div align="right"><font color="#ff8000"><%=quHotList.getFieldValue("str_value")%></font></div>
          </td>
        </tr>
        <tr> 
          <td height=10 width="10" class="pt9"></td>
...
%> 
    ...
    <td width="155" height="313" valign="top">
        ...
        <table width="155" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="155"><img src="../../images/gb/hot_hotel.gif" width="155" height="31"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="58" width="155">
              <div align="right"><img src="../../images/gb/chabooking.gif" width="138" height="54"></div>
            </td>
          </tr>
          <tr>
            <td width="155">
              ...
              <table width="139" border="0" cellspacing="0" cellpadding="0" align="right">
                ...
                <tr align="center">
                  <td height="29"><img src="../../images/gb/search-1.gif" width="139" height="26"></td>
                </tr>
                <tr align="center">
                  <td height="25"> 
                    <select name="stateId" size="1" onChange="updateMenus()">
                      <option>-按省市名称搜索-</option>
					  <option 	 > 北京 </option>
					  <option 	 > 上海 </option>
					  <option >　香港　</option>
					  <option >　天津　</option>
                ...
                <tr align="center">
                  <td> <font color="#666666">按酒店名称搜索</font></td>
                </tr>
                <tr align="center">
                  <td>
                ...
                <tr align="center">
                  <td><img src="../../images/gb/search-2.gif" width="139" height="21" usemap="#Map2" border="0"><map name="Map2"><area shape="rect" coords="56,3,130,18" href="JavaScript:AllSearch();"><area shape="rect" coords="6,3,45,18" href="JavaScript:Search();"></map></td>
                </tr>
  ...
  <tr>
    <td height="160" colspan="3">
      <table width="660" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFCC00" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF">
        ...
        <tr align="center" valign="middle"> 
          <td width="110" height="20"><a href="http://www.YeahTour.com" target="_blank">四川旅游网</a></td>
          <td width="110" height="20"><a href="http://cxits.yeah.net" target="_blank">北京协力国旅</a></td>
