    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="../../images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;酒店资料</font><!-- #EndEditable --></td>
        ...
        <tr valign=top> 
            ...
            <table border="0" width="100%" cellpadding="0" cellspacing="0">
              <tr> 
                <td class="txt">&nbsp;&nbsp;&nbsp;&nbsp;<%=fullDesc%><br>
                  <br>
                  <b><font color="#000000">主要设施</font></b><font color="#000000">：</font><br>
                  &nbsp; 
                  <table width="450" border="0" cellspacing="0" cellpadding="2">
                    <tr> 
                      <td width="72" valign="top">餐饮设施：</td>
                      <td width="378"><%=facilityDrink%></td>
                    </tr>
                    <tr> 
                      <td width="72" valign="top">娱乐设施：</td>
                      <td width="378"><%=facilityEnt%></td>
                    </tr>
                    <tr> 
                      <td width="72" valign="top">服务设施：</td>
                      ...
                      <td colspan="2"> 
                        <table width="420" border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF">
                          <tr> 
                            ...
                            <td height="26" width="50"> 
                              <div align="center"><font color="#666666">节日价</font></div>
                            </td>
                          </tr>
                          <%
                          ...
                          <tr> 
                            ...
                            <td height="26" width="80"> 
                              <div align="center">从<%=price[i][7]%><br>至<%=price[i][8]%></div>
                            </td>
                            <% }else{%>                 
                            <td height="26" width="80"> 
                            ...
                            <% }%>                                      
                            <td height="26" width="50"> 
                              <div align="center"><%=price[i][2]%></div>
                            </td>
                  ...
                  <br>
                  <a href="HotelBooking.jsp?hotelId=<%=hotelId%>"><img border="0" src="../../images/gb/booking.gif" width="138" height="18" align="right"></a><br>
          ...
          <table border=0 cellspacing=2 cellpadding=2 width="600" >
            <tr align="center"><font color="#666666"> 
              <td> 
                <p class="txt">电话：<%=telephone%> 传真：<%=fax%><br>
                  地址：<%=address%>
              </td>
            </tr>
          </table>
