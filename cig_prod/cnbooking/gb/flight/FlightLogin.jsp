...
function Search_check()
{
		...
		{
			window.alert("您选择的出发地点与目的地相同, 请重新选择 !");
			document.searchForm.homecity.focus();
			return;
		}
...
<!--//
	function DateSubmit_Check()
	{
		...
		{
				window.alert("对不起, "+document.searchForm.d_Year.options[document.searchForm.d_Year.selectedIndex].value+"-"+document.searchForm.d_Month.options[document.searchForm.d_Month.selectedIndex].value+"-"+document.searchForm.d_Day.options[document.searchForm.d_Day.selectedIndex].value+" 这一天不存在, 请检查出发日期 !");
				document.searchForm.homecity.focus();
		...
		{
			window.alert("对不起, "+document.searchForm.a_Year.options[document.searchForm.a_Year.selectedIndex].value+"-"+document.searchForm.a_Month.options[document.searchForm.a_Month.selectedIndex].value+"-"+document.searchForm.a_Day.options[document.searchForm.a_Day.selectedIndex].value+" 这一天不存在, 请检查返回日期 !");
			document.searchForm.homecity.focus();
		...
		{
			window.alert("请注意, 返回日期不可能小于出发日期 !");
			document.searchForm.homecity.focus();
			document.searchForm.a_Day.focus();
			return false;
		} 
    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;航线搜索</font><!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
      ...
      <input type=hidden name=curDate value=<%=nowDate%>>
        <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <table width="380" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFBC04" align="center">
                <tr valign="middle" align="center"> 
                  <td width="340">
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出发地点：</font></td>
                            </tr>
                          </table>
                        </td>
	                ...
	                <OPTION VALUE="none">请选择出发的城市</OPTION>
	                ...
	                <%}%>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出票地点：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="240"> 
                        ...
                        <OPTION VALUE="none">请选择出票地点</OPTION>
	                <option value=none>--------------</option>
                        <%for(int i=0;i<cityCount;i++){ %>
	                <OPTION VALUE="<%=cityList[i][0]%>"><%=cityList[i][1]%></OPTION>
	                <%}%>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">到达地点：</font></td>
                            </tr>
                          </table>
                        </td>
                        <%
		          ...
		          <OPTION VALUE="none">请选择目的地城市</OPTION>
		          <option value=none>--------------</option>
                          <%for(int i=0;i<cityCount;i++){ %>
	                  <OPTION VALUE="<%=cityList[i][0]%>"><%=cityList[i][1]%></OPTION>
	                  <%}%>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出发日期：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="240"> 
          ...
          <tr align="center"> 
            <td class="txt"><a href="javascript:Search_check();"><img src="/images/gb/search.gif" width="138" height="18" border="0"></a></td>
          </tr>
          <tr align="center"> 
            <td class="txt">&nbsp;</td>
          </tr>
