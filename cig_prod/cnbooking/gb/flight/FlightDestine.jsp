...
<%
    ...
    curr_Price_A = request.getParameter("curr_Price_A");
    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom">==&gt;&gt;<!-- #BeginEditable "top" -->机票预订<!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" -->
     ...
     <input type=hidden name=flight_Seq_A value="<%=flight_Seq_A%>">
          ...
          <tr align="center"> 
            <td height="60"> 
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>出发机票</b></font></span></td>
                </tr>
                <tr align="center"> 
                    ...
                    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" height="274">
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">航班号：</font></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">起飞时间：</font></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">顾客姓名：</font></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">价格/币别：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="310"><%if(curr_Price!=null){%><%=currency%><%=curr_Price%><%}else{%> 请电 <%}%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">舱位等级：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="310"> 
                          <select name="hseatClass" disabled >
                            <option <%if(seatClass.equals("E")){%> selected <%}%> >经济舱</option>
                            <option <%if(seatClass.equals("B")){%> selected <%}%>> 公务舱</option>
                            <option <%if(seatClass.equals("F")){%> selected <%}%>>头等舱</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
                  ...
                  <td width="340"> 
                    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" height="241">
                      ...
                      <tr> 
                        ...
                        <td height="30" width="310"><%if(curr_Price_A!=null){%><%=currency_A%><%=curr_Price_A%><%}else{%> 请电 <%}%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                        ...
                        <td height="30" width="310"> 
                          <select name="select2" disabled >
                            <option <%if(seatClass_A.equals("E")){%> selected <%}%> >经济舱</option>
                            <option <%if(seatClass_A.equals("B")){%> selected <%}%>> 公务舱</option>
                            <option <%if(seatClass_A.equals("F")){%> selected <%}%>>头等舱</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
               ...
               <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                  <tr align="center" bgcolor="#CFC8CF"> 
                    <td height="3"><img src="/images/space.gif" width="1" height="3"></td>
                      ...
                      <tr align="center"> 
                        <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>联系信息</b></font></span></td>
                      </tr>
                      <tr align="center"> 
                        <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                      </tr>
        ...
        <table width="450" border="0" cellspacing="0" cellpadding="0" align="center">
          ...
          <tr> 
            <td> 
              <div align="center"><a href="javascript:checkdata('<%=round_Trip%>');"><img src="/images/gb/enter_air1.gif" width="138" height="18" border="0"></a></div>
            </td>
          </tr>
        </table>
      </form>
