    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;商旅新闻</font><!-- #EndEditable --></td>
        ...
        <tr align="center"> 
          <td><br>
            <table width=250 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
              ...
              <tr align="center"> 
                <td><span class="bigtxt"><font class="bigtxt"><b><font color="#666666">商旅新闻</font></b></font></span></td>
              </tr>
              <tr align="center"> 
                ...
                <td>
                  <div align="center">
                    <table width="440" cellpadding="0" cellspacing="0" bordercolorlight="#FFCC00" border="1" bordercolordark="#FFFFFF">
                      <tr> 
                        <td height="20" width="140">第<%=pageno%>页</td>
                    ...
                    %>                    
                      <tr> 
                        ...
                        <td height="20" width="350"><span class="txt"><a href="<%=newslist[i][4]%>"><%=newslist[i][1]%></a></span></td>
                      ...
                      <tr> 
                        <td height="20" width="20" align="center" valign="middle"><img src="/images/news_title.gif" width="8" height="8"></td>
                        <td height="20" width="350"><span class="txt"><a href="newsStyle<%=newslist[i][3]%>.jsp?news_id=<%=newslist[i][0]%>"><%=newslist[i][1]%></a></span></td>
                        <td height="20" width="70"> 
                          <div align="center"><span class="txt"><%=newslist[i][2]%></span></div>
                        </td>
                      </tr>
