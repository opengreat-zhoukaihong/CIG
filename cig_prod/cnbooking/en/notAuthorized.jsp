    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;Size In</font><!-- #EndEditable --></td>
  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> <br>
      <table width=400 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
        ...
        <tr align="center"> 
          <td><b><span class="bigtxt"><font color="#666666">Sorry, you have not logged in or your session has timed out. </font></span></b></td>
        </tr>
        <tr align="center"> 
...
//-->
          ...
          <form name="LoginForm" action="/cnbooking/en/CnBookingLogin.jsp?answerInput=" method="POST">
            <td align="center"> 
              <table border="0" width="134" cellspacing="0" cellpadding="0" bgcolor="#CFC8CF">
                ...
                <tr align="center" bgcolor="#FFDA9D"> 
                  <td> Password:  
                    <input type="password" name="passwd" size="11" >
                  </td>
                </tr>
                <tr align="center" bgcolor="#FFDA9D"> 
                ...
                <tr bgcolor="#FFDA9D"> 
                  <td height="8" align="center"><a href="javascript:PostForm()"><font color="#000000">Login</font></a>&nbsp;<a href="javascript:PostGetForm()"><font color="#000000">Forget password</font></a></td>
                </tr>
                <tr> 
          ...
          <td align="center"> 
            <table width="210" border="1" cellspacing="0" cellpadding="8" height="130" bordercolor="#FFBC04">
              <tr align="center" valign="top"> 
                <td>if your are not member,<br>
                  please <a href="/cnbooking/en/free_register.jsp"><b><font color="#000000">Register now!</font></b></a></td>
              </tr>
            </table>
          </td>
        </tr>
