    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" -->==&gt;&gt;Flight Matches Listed <!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
     <form name="flightListForm" method="post" action="FlightDestine.jsp">
          ...
          <tr align="center"> 
            <td height="60"> <br>
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font color="#000000">the departure flight(s)</font></b></font></span></td>
                </tr>
                <tr align="center"> 
                  <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                </tr>
          ...
          <tr align="center"> 
            <td class="txt">&nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  <td> 
                    <table width="640" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="center" valign="middle"> 
                        <td width="30">Reserve</td>
                        <td width="64">Flight Number</td>
                        <td height="20" width="64">Departure Time</td>
                        <td height="20" width="64">Arrival Time</td>
                        <td height="20" width="64">Departure airport</td>
                        <td height="20" width="64">Arrival airport</td>
                        <td height="20" width="64">Airline</td>
                        <td height="20" width="64">Plane Type</td>
                        <td height="20" width="64">Class</td>
                        <td height="20" width="64"> Price </td>
                        <td height="20" width="64">Current price</td>
                        <td height="20" width="64"> Stops </td>
                      </tr>
                      <tr bgcolor="#FFBC04"> 
              ...
              <%
                        ...
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][10].equals("E")){%>Economy<%}%><%if(flightLists[i][10].equals("F")){%>First<%}%><%if(flightLists[i][10].equals("B")){%>Business<%}%></div>
                        </td>
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][7]!=null){%><%=flightLists[i][7]%><%=flightLists[i][9]%><%}else{%>Please Call<%}%></div>
                        </td>
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][8]!=null){%><%=flightLists[i][8]%><%=flightLists[i][9]%><%}else{%>Please Call<%}%></div>
                        </td>
        ...
        <tr align="center">
          ...
          <tr align="center"> 
            <td class="txt"><font color="#FF0000"><b>Sorry, there are no flights to your desired destination, Please adjust your search conditions!</b></font></td>
          </tr>
          <tr align="center"> 
            <td class="txt">&nbsp;</td>
          </tr>
          ...
          <tr align="center"> 
            <td> 
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font color="#000000">the return flight(s)</font></b></font></span></td>
                </tr>
                <tr align="center"> 
                  <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                </tr>
                    ...
                    <table width="640" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <%
              	     ...
              	     for (int i=0;i<maxNum;i++){
                        ...
                        <td height="30"> 
                          <div align="center"><%if(flightLists1[i][10].equals("E")){%>Economy<%}%><%if(flightLists1[i][10].equals("F")){%>First<%}%><%if(flightLists1[i][10].equals("B")){%>Business<%}%></div>
                        </td>
                        <td height="30"> 
                        ...
                        <td height="30" width="30"><div align="center"><%=flightLists1[i][11]%></div></td>
                      </tr>
             </table>
            </td>
            </tr>
...
function checkdata(sWay)
	{
		if (document.flightListForm.flight_ID.value.length == 0) {
			window.alert("Please  choose the departure flight !");
			return;
		  }
		if (sWay=="R" && document.flightListForm.flight_ID_A.value.length == 0) {
			window.alert("please choose the return  flight !");
			return;
        	  }	
...
//-->
 ...
 <div align="center"><a href="javascript:checkdata('<%=flightWay%>');"><img src="/images/en/enter_air.gif" width="138" height="18" border="0"></a> 
 </div>
...
<!-- #EndEditable --></td>
  ...
  <tr align="center"> 
  <td colspan="3" height="20" ><a href="javascript:window.history.go(-1);">back</a></td>
  </tr>
  <tr> 
