...
PostNew.setFax(fax);
	...
	info += "Congratulations!,departure put out successfully!<br>";
    }
    else{
	info +="Sorry,departure put out failed, please check !";
    }
    if(round_Trip.equals("R")){
    ...
    if(PostNew.addFlightBooking()){ 
	info += "Congratulations!,flight booking successfully!<br>";
    }
    else{
	info +="Sorry,flight booking failed, please check !";
    }
   }
