    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom">==&gt;&gt;<!-- #BeginEditable "top" -->Ticket Reservation<!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" -->
     ...
     <input type=hidden name=flight_Seq_A value="<%=flight_Seq_A%>">
          ...
          <tr align="center"> 
            <td height="60"> 
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>departure ticket</b></font></span></td>
                </tr>
                <tr align="center"> 
                    ...
                    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" height="274">
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">Flight Number: </font></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">Departure Time: </font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="310"><%=d_Year%> Year <%=d_Month%>Month <%=d_Day%>Day <%=takeoff_Time%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">Passenger Name: </font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="310"> Chinese:  
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">Price/Currency: </font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="310"><%if(curr_Price!=null){%><%=currency%><%=curr_Price%><%}else{%>Please Call<%}%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                        ...
                        <td height="30" width="310"> 
                          <select name="hseatClass" disabled >
                            <option <%if(seatClass.equals("E")){%> selected <%}%> >Economy</option>
                            <option <%if(seatClass.equals("B")){%> selected <%}%>>Business</option>
                            <option <%if(seatClass.equals("F")){%> selected <%}%>>First</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
                        <td height="103" width="140" valign="top">&nbsp; 
                          <div id="pgtitle" style="position:absolute; width:121px; height:26px; left: 171px; top: 386px; z-index:1; visibility: hidden"> 
                            <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                              <tr align="center"> 
                                <td><font color="#000000">Other Passenger(s): </font></td>
                              </tr>
                            </table>
                          </div>&nbsp;
                            </td>
          ...
          <tr align="center"> 
            <td height="60"> 
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font color="#000000">the return ticket</font></b></font></span></td>
                </tr>
                <tr align="center"> 
                  <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                </tr>
                  ...
                  <td width="340"> 
                    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" height="241">
                      ...
                      <tr> 
                        ...
                        <td height="30" width="310"><%=a_Year%> Year <%=a_Month%>Month <%=a_Day%>Day <%=takeoff_Time_A%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                      ...
                      <tr> 
                        ...
                        <td height="30" width="310"><%if(curr_Price_A!=null){%><%=currency_A%><%=curr_Price_A%><%}else{%>Please Call<%}%></td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                        ...
                        <td height="30" width="310"> 
                          <select name="select2" disabled >
                            <option <%if(seatClass_A.equals("E")){%> selected <%}%> >Economy</option>
                            <option <%if(seatClass_A.equals("B")){%> selected <%}%>>Business</option>
                            <option <%if(seatClass_A.equals("F")){%> selected <%}%>>First</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
               ...
               <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                  <tr align="center" bgcolor="#CFC8CF"> 
                    <td height="3"><img src="/images/space.gif" width="1" height="3"></td>
                      ...
                      <tr align="center"> 
                        <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>contact information</b></font></span></td>
                      </tr>
                      <tr align="center"> 
                        <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                      </tr>
                    ...
                    <table width="333" border="0" cellspacing="0" cellpadding="0" align="center">
                      <tr> 
                        <td align=left height="18" width="363"> UserName&nbsp;&nbsp;&nbsp;&nbsp;:  
        ...
        <table width="450" border="0" cellspacing="0" cellpadding="0" align="center">
          ...
          <tr> 
            <td> 
              <div align="center"><a href="javascript:checkdata('<%=round_Trip%>');"><img src="/images/en/enter_air1.gif" width="138" height="18" border="0"></a></div>
            </td>
          </tr>
        </table>
      </form>
