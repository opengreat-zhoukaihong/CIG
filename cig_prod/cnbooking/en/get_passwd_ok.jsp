...
%>
	<jsp:forward page="failed.jsp?info=Sorry, the answer is incorrect!&title=Get Password" />
	</jsp:forward>
<%
}
%>
...
{ 
 ...
 if(document.changForm.passwd.value!= document.changForm.passwd1.value){
 	  alert("the two password is not same ,please check !\n");
          document.changForm.passwd.focus();
          return;
 }
          ...
          <tr align="center"> 
            <td height="60"> 
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>Change Password</b></font></span></td>
                </tr>
                <tr align="center"> 
                ...
                <tr> 
                  <td> &nbsp;&nbsp; 
                    <table width="333" border="0" cellspacing="0" cellpadding="0" align="center">
                      <tr> 
                        <td height="28" colspan="2">please enter new password,and repeat it¡£</td>
                      </tr>
                      <tr> 
                        <td height="28" width="55">password: </td>
                        <td height="28">
                      ...
                      <tr> 
                        <td height="28" colspan="2"> 
                          <div align="center"> 
                            <p><a href="javascript:PostForm()"><img src="/images/en/modify_data.gif" width="138" height="18" border="0"></a></p>
                          </div>
                        </td>
                      </tr>
                    </table>
