...
quHotList.setRow(1);
String hotHotelName = quHotList.getFieldValue("city_name") + "<br>" + quHotList.getFieldValue("name");
...
popup = window.open('', 'popupnav', 'width=360,height=290,resizable=1,scrollbars=auto');
if (popup != null) {
if (popup.opener == null) {
popup.opener = self; 
}
popup.location.href = '../../en/2001.htm';
}
// -->
</script>
<head>
...
for (int i = 1; i <= rowCount ; i++)
{
   ...
   if (!stateName.equals(quHotList.getFieldValue("state_name")))
   {
      ...
      strCity = strCity + "*------City-----|0|" + quHotList.getFieldValue("state_id");
   }
...
{
 // if(newparent=="-----State-----" && childfields[0]!="------City-----")
...
function AllSearch()
{
document.myForm.stateId.options[document.myForm.stateId.selectedIndex].text="-----State-----";
document.myForm.cityId.options[document.myForm.cityId.selectedIndex].text="------City-----";
document.myForm.starId.options[document.myForm.starId.selectedIndex].text="-----Star------";
...
if(mystate=="-----State-----" && mycity=="------City-----" && star=="-----Star------" &&  validateSpaceField(hotel))
{
...
function bookmark(){
window.external.AddFavorite("http://www.cnbooking.com", "中港澳酒店订房专家")
}
// -->
</script>
</head>
...
<table width="665" border="0" cellspacing="0" cellpadding="0" align="center" height="34">
  ...
  <tr> 
    <td width="664" height="12" bgcolor="#CCCCCC"><a href="/cnbooking/gb/index.jsp"><img src="../../images/gb.gif" width="71" height="12" border="0"></a><a href="/cnbooking/big/index.jsp"><img src="../../images/big.gif" width="71" height="12" border="0"></a></td>
  </tr>
  <tr> 
    <td width="664" height="25"><img src="../../images/en/top_bar.gif" width="664" height="25" usemap="#Map" border="0"><map name="Map"><area shape="rect" coords="224,7,330,20" href="../../en/user_manual.htm"><area shape="rect" coords="341,7,405,20" href="../../en/abouts.htm"><area shape="rect" coords="410,7,457,20" href="../../en/jobs.htm"><area shape="rect" coords="462,7,547,20" href="../../en/co-operation.htm"><area shape="rect" coords="553,7,646,20" href="../../en/secrecy.htm"></map></td>
  </tr>
</table>
  ...
  <tr>
    <td width="155" height="313" valign="top">
            ...
            <table border="0" width="126" cellspacing="0" cellpadding="0" align="center">
              <form name="LoginForm" action="CnBookingLogin.jsp?answerInput=" method="POST">
                <tr align="center" bgcolor="#FFDA9D">
                  <td><span class="pt9">Member: </span>
                    <input type="text" name="username" size="9" style="font-family: "Verdana", ",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",","Times New Roman";font-size: 12px;">
                  </td>
                </tr>
                <tr align="center" bgcolor="#FFDA9D">
                  <td><span class="pt9">Password: </span>
                    <input type="password" name="passwd" size="9" style="font-family: "Verdana", ",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",",","Times New Roman";font-size: 12px;">
                  </td>
                </tr>
                <tr bgcolor="#FFDA9D">
                  <td height="8" align="center"><a href="javascript:document.LoginForm.submit()"><font color="#000000"><span class="pt9">Login</span></font></a>
                    <span class="pt9"><a href="free_register.jsp"><font color="#000000">Register</font></a></span></td>
                </tr>
                <tr>
      ...
      <table width="155" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="126" height="89"> <a href="../../en/hotel_whole_sale.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','../../images/en/link_01b.gif',1)"><img src="../../images/en/link_01a.gif" width="127" height="22" border="0" name="Image1"></a> 
            <a href="../../en/hotel_boardinghouse_main.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','../../images/en/link_02b.gif',1)"><img src="../../images/en/link_02a.gif" width="127" height="22" border="0" name="Image2"></a> 
            <a href="tour/TourLogin.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','../../images/en/link_03b.gif',1)"><img src="../../images/en/link_03a.gif" width="127" height="22" border="0" name="Image3"></a> 
            <a href="../../en/car.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','../../images/en/link_04b.gif',1)"><img src="../../images/en/link_04a.gif" width="127" height="22" border="0" name="Image4"></a> 
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','../../images/en/link_05b.gif',1)"><img src="../../images/en/link_05a.gif" width="127" height="22" border="0" name="Image5"></a> 
            <a href="../../en/golf.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','../../images/en/link_06b.gif',1)"><img src="../../images/en/link_06a.gif" width="127" height="22" border="0" name="Image6"></a> 
            <a href="../../en/translators.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','../../images/en/link_07b.gif',1)"><img src="../../images/en/link_07a.gif" width="127" height="22" border="0" name="Image7"></a> 
            <a href="flight/FlightLogin.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','../../images/en/link_08b.gif',1)"><img src="../../images/en/link_08a.gif" width="127" height="22" border="0" name="Image8"></a> 
            <a href="free_register.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','../../images/en/link_09b.gif',1)"><img src="../../images/en/link_09a.gif" width="127" height="22" border="0" name="Image9"></a> 
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','../../images/en/link_10b.gif',1)"><img src="../../images/en/link_10a.gif" width="127" height="22" border="0" name="Image10"></a> 
          </td>
      ...
      <table width="155" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="flight/FlightLogin.jsp"><img src="../../images/en/air_logo.gif" width="155" height="108" border="0"></a></td>
        </tr>
      </table>
    </td>
    <td width="355" height="313" valign="top">
      <table width="355" border="0" cellspacing="0" cellpadding="0" height="55">
        <tr>
          <td><img src="../../images/en/super.gif" width="350" height="50"></td>
        </tr>
      </table>
      <table border="0" width="355" cellspacing="0" cellpadding="0">
        <tr> 
          <td height=10 width="6" class="pt9"></td>
...
%> 
        <tr> 
          <td height=10 width="6" class="pt9"></td>
          <td valign=center width=250 class="pt9"><a href="hotel_detail.jsp?hotelId=<%=quHotList.getFieldValue("Hotel_id")%>"><font color="#FF8000"><%=quHotList.getFieldValue("city_name") + " " + quHotList.getFieldValue("name")%> 
            </font></a></td>
          ...
          <td valign=center width=30 class="pt9"><font color="#ff8000"><%
...
%></font></td>
          <td valign=center width=2 class="pt9"> 
            <div align="right"></div>
          </td>
        </tr>
        <tr> 
          <td height=10 width="6" class="pt9"></td>
          <td valign=center colspan="4" class="pt9" height="5"><img src="../images/line.gif" width="345" height="1"></td>
        </tr>
        <%
}
out.print(quHotList.getMessage());
%> 
        <tr> 
          <td width="6" height="22" class="pt9"></td>
          <form name="form1">
            <td valign="middle" colspan="4" class="pt9" height="26" align="right"> 
    ...
    <td width="155" height="313" valign="top">
        ...
        <table width="155" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="155"><img src="../../images/en/hot_hotel.gif" width="155" height="31"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="58" width="155">
              <div align="right"><img src="../../images/en/chabooking.gif" width="138" height="54"></div>
            </td>
          </tr>
          <tr>
            <td width="155">
              ...
              <table width="139" border="0" cellspacing="0" cellpadding="0" align="right">
                ...
                <tr align="center">
                  <td height="29"><img src="../../images/en/search-1.gif" width="139" height="26"></td>
                </tr>
                <tr align="center">
                ...
                <tr align="center">
                  <td height="25"><font color="#666666">Rate</font> 
                    <input type="text" name="priceForm" size="3" maxlength="5">
                    <font color="#666666">To</font> 
                    <input type="text" name="priceTo" size="3" maxlength="5">
                  </td>
                </tr>
                <tr align="center">
                  <td> <font color="#666666">Search By Hotel Name</font></td>
                </tr>
                <tr align="center">
                  <td>
                    <input type="text" name="hotelName" size="20" value="" maxlength="20" >
                  </td>
                </tr>
                <tr align="center">
                  <td><img src="../../images/en/search-2.gif" width="139" height="21" usemap="#Map2" border="0"><map name="Map2"><area shape="rect" coords="56,3,130,18" href="JavaScript:Search();"><area shape="rect" coords="6,3,45,18" href="JavaScript:AllSearch();"></map></td>
                </tr>
