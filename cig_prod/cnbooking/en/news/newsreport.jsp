  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> <br>
      ...
      <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
        ...
        <tr align="center"> 
          <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Relative 
            News Report</font></b></font></span></td>
        </tr>
        <tr align="center"> 
      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <td> 
                  <div align="left"> 
                    <table width="540" cellpadding="0" cellspacing="0" bordercolorlight="#FFCC00" border="1" bordercolordark="#FFFFFF">
                      <tr> 
                        <td height="20" width="240">Page <%=pageno%></td>
        ...
        <tr align="center"> 
          <td><font color="#666666"><a href="/en/abouts.htm">Back</a></font></td>
        </tr>
      </table>
      <!-- #EndEditable --></td>
  </tr>
