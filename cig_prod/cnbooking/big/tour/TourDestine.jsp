...
<!--//
 var prices = new Array ("<%=TourViewDetail.getPrice0()%>", "<%=TourViewDetail.getPrice1()%>", "<%=TourViewDetail.getPrice2()%>", "<%=TourViewDetail.getPrice3()%>", "<%=TourViewDetail.getPrice4()%>", "<%=TourViewDetail.getPrice5()%>", "<%=TourViewDetail.getPrice6()%>");
        ...
        var weekds,date1,k
          ...
          if(k==0){k="日";}
          window.alert("請注意, 出發日是星期"+k+",沒有開班! ");
          return false;
        }
	...
	function DateSubmit_Check()
	{
	     ...
	     {
				window.alert("對不起, "+document.frmPost.d_Year.options[document.frmPost.d_Year.selectedIndex].value+"-"+document.frmPost.d_Month.options[document.frmPost.d_Month.selectedIndex].value+"-"+document.frmPost.d_Day.options[document.frmPost.d_Day.selectedIndex].value+" 這一天不存在, 請檢查出發日期 !");
  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
     <form method="post" name="frmPost" action="TourAddPost.jsp">
      ...
      <input type=hidden name=weekdays value="<%=Convert.g2b(weekdays)%>">
      <input type=hidden name=curDate value=<%=nowDate%>>
      <input type=hidden name=cust_id value="<%=cust_id%>">
      <input type=hidden name=curr_Price >
      <input type=hidden name=currency value="<%=Convert.g2b(TourViewDetail.getCurrency())%>">
          ...
          <tr> 
            ...
            <td width=500 valign="top"><br>
              ...
              <table border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr> 
                  <td class="txt"><%=Convert.g2b(TourViewDetail.getTour_Sche())%>&nbsp;<br><br>
                    <b><font color="#000000">服務內容</font></b><font color="#000000">：</font><br>
                    &nbsp; 
                    ...
                    <table width="358" border="0" cellspacing="0" cellpadding="0" align="center">
                      <tr> 
                        <td colspan="2"> 
                          <table width="358" border="1" cellspacing="0" cellpadding="4" align="center" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF">
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">出團日期：</font></div>
                              </td>
                            ...
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">費用：</font></div>
                              </td>
                              <td height="26" width="75%"> 
                                <div align="left"><%if(price!="1000000"){%> <%=Convert.g2b(TourViewDetail.getCurrency())%><%=Convert.g2b(price)%><%}else{%>請電 <%}%></div>
                              </td>
                            </tr>
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">出發人數：</font></div>
                              </td>
                              <td height="26" width="75%">
                            ...
                            <tr> 
                              <td height="26" width="25%"> 
                                <div align="right"><font color="#666666">出發日期：</font></div>
                              </td>
                              <td height="26" width="75%">
                                <div align="center">
                          ...
                          <SELECT NAME=d_Day SIZE=1 Class=Small><%for(int i=1;i<32;i++){%><OPTION VALUE="<%=i%>" <%if(nowDay==i){%>selected<%}%> ><%=i%></OPTION><%}%></select>日
                          </div></td>
                            </tr>
                          </table>
                        </td>
