...
<table width="500" border="0" cellspacing="0" cellpadding="0" height="24">
                <tr> 
                 ...
                 <td bgcolor="#FFBC04"> 
                    <div align="center"><font face="黑体" size="3"><a href="#<%=Convert.g2b(cityLists[i][0])%>">&nbsp;<%=Convert.g2b(cityLists[i][1])%>&nbsp;</a></font></div>
                  </td>
                 <%}%>
                </tr>
              </table>
          ...
          %>
          <tr> 
            <td height="22" bgcolor="<%=Convert.g2b(colors[i])%>"><a name="<%=Convert.g2b(cityLists[i][0])%>"></a><font face="黑体" size="3">&nbsp;<%=Convert.g2b(cityLists[i][1])%></font></td>
          </tr>
          <tr> 
            <td> 
          ...
          <tr> 
            <td> 
              <div align="center"><a href="#top">返回上一級</a></div>
            </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
          ...
          <tr> 
            <td> 
              <div align="center"><a href="javascript:window.history.go(-1)">返回</a></div>
            </td>
          </tr>
          <tr> 
            <td>&nbsp; </td>
