  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" -->
      <table width="440" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr align="center"> 
          <td><br>
            <table width=250 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
              ...
              <tr align="center"> 
                <td><span class="bigtxt"><font class="bigtxt"><b><font color="#666666">商旅新聞</font></b></font></span></td>
              </tr>
              <tr align="center"> 
        ...
        <tr align="center"> 
          <td class="txt">&nbsp;&nbsp;&nbsp;&nbsp; 
            <table width="440" border="1" cellspacing="0" cellpadding="10" bordercolor="#FFCC00">
              <tr>
                <td>
                  <div align="center">
                    <table width="440" cellpadding="0" cellspacing="0" bordercolorlight="#FFCC00" border="1" bordercolordark="#FFFFFF">
                      <tr> 
                        <td height="20" width="140">第<%=pageno%>頁</td>
                    ...
                    %>                    
                      <tr> 
                        ...
                        <td height="20" width="350"><span class="txt"><a href="<%=newslist[i][4]%>"><%=Convert.g2b(newslist[i][1])%></a></span></td>
                      ...
                      <tr> 
                        <td height="20" width="20" align="center" valign="middle"><img src="/images/news_title.gif" width="8" height="8"></td>
                        <td height="20" width="350"><span class="txt"><a href="newsStyle<%=newslist[i][3]%>.jsp?news_id=<%=newslist[i][0]%>"><%=Convert.g2b(newslist[i][1])%></a></span></td>
                        <td height="20" width="70"> 
                          <div align="center"><span class="txt"><%=newslist[i][2]%></span></div>
                        </td>
                      </tr>
