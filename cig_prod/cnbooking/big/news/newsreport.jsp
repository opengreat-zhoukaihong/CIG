    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;相關新聞報道</font><!-- #EndEditable --></td>
  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> <br>
      ...
      <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
        ...
        <tr align="center"> 
          <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b>相關新聞報道</b></font></span></td>
        </tr>
        <tr align="center"> 
      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <td> 
                  <div align="left"> 
                    <table width="540" cellpadding="0" cellspacing="0" bordercolorlight="#FFCC00" border="1" bordercolordark="#FFFFFF">
                      <tr> 
                        <td height="20" width="240"> 第<%=pageno%>頁</td>
                        <td height="20" width="200"> 
                          <div align="center">共<%=newsCount%>條新聞 共<%=totalPage%>頁</div>
                        </td>
                        <% if (pageno>1){%>
                        <td height="20" width="50"> 
                          <div align="center"><a href="newsreport.jsp?pageNo=<%=pageno-1%>">上一頁</a></div>
                        </td>
                        <% }if ((pageno!=totalPage)&&(totalPage>1)){%> 
                        <td height="20" width="50"> 
                          <div align="center"><a href="newsreport.jsp?pageNo=<%=pageno+1%>">下一頁</a></div>
                        </td>
                        <% }%>
                      </tr>
                    </table>
                    ...
                    %>
                      <tr> 
                        ...
                        <td height="20" width="340"><span class="txt"><a href="<%=newslist[i][4]%>"><%=Convert.g2b(newslist[i][1])%></a></span></td>
                        <td height="20" width="11"> 
                          <div align="center"><span class="txt"><<%=Convert.g2b(newslist[i][5])%>></span></div>
                        </td>
                      ...
                      <tr> 
                        <td height="20" width="20" align="center" valign="middle"><img src="/images/news_title.gif" width="8" height="8"></td>
                        <td height="20" width="340"><span class="txt"><a href="newsStyle<%=newslist[i][3]%>.jsp?news_id=<%=newslist[i][0]%>"><%=Convert.g2b(newslist[i][1])%></a></span></td>
        ...
        <tr align="center"> 
          <td><font color="#666666"><a href="/big/abouts.htm">返回</a></font></td>
        </tr>
      </table>
      <!-- #EndEditable --></td>
  </tr>
