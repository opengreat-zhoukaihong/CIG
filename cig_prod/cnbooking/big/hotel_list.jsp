    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="../../images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;酒店搜索結果</font><!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
          ...
          <td> 
            <table width="600" border="0">
              <form name="myForm" method="post" action="<%="hotel_list.jsp?"+str%>">
                <tr> 
                  <td>&nbsp;&nbsp;共查到<font color="#FF3333"><%=hotel_count%></font>條信息&nbsp;&nbsp; 
 		    <% if (pageno !=1){%>                 
                    <a href="<%="hotel_list.jsp?pageNo=1"+str%>">首頁</a> <img src="../../images/first_page.gif" width="12" height="13" border="0"> 
                    <a href="<%="hotel_list.jsp?pageNo="+(pageno-1)+str%>">上一頁</a> <img src="../../images/up_page.gif" width="12" height="13" border="0"> 
                    <%}%>
                    <% if (pageno !=total_page){%>
                    <font color="#000000"><a href="<%="hotel_list.jsp?pageNo="+(pageno+1)+str%>">下一頁</a></font><img src="../../images/down_page.gif" width="12" height="13" border="0"> 
                    <font color="#000000"><a href="<%="hotel_list.jsp?pageNo="+total_page+str%>">尾頁</a></font><img src="../../images/last_page.gif" width="12" height="13" border="0"> 
                    <%}%>
                  </td>
                  <td>第 
                    <input type="text" name="pageNo" size="2">
                    頁 <a href="javascript:Search();"><b><i><font face="Arial, Helvetica, sans-serif" color="#666666">GO</font></i></b></a></td>
                  <td width="50" align="center">第<%=pageno%>頁</td>
                  <td width="50" align="center">共<font color="#FF0000"><%=total_page%></font>頁</td>
                </tr>
              </form>
            </table>
          </td>
      ...
      <table align=center cellpadding=0 cellspacing=6 href="hotel_bj_5_xsj.htm" width="600">
        <tr valign="baseline"> 
          ...
          <td width=51 align=center>圖文介紹</td>
          <td width=134 align=center>名稱 <img src="../../images/index.gif" width="12" height="13" border="0"></td>
          <td width=62 align=center>星級 <img src="../../images/index.gif" width="12" height="13" border="0"></td>
          <td width=64 align=center>在線預定</td>
          <td width=54 align=center>會員价 <img src="../../images/index.gif" width="12" height="13" border="0"></td>
          <td width=85 align=center>位置 <img src="../../images/index.gif" width="12" height="13" border="0"></td>
          <td width=65 align=center>优惠服務</td>
        </tr>
        <tr> 
        ...
        <%}%>
          <td align="center" width="64"><a href="HotelBooking.jsp?hotelId=<%=hotel_list[i][0]%>"><font color="#999900"><b>預訂!</b></font></a></td>
        ...
        <tr> 
          <td width="29">&nbsp;</td>
          <td colspan=7><img src="../../images/pick.gif" width="16" height="16">：特別推荐 
            <img src="../../images/icon.gif" width="12" height="13" border="0"> ：圖文介紹 
            <img src="../../images/breakfast.gif" width="16" height="16">：詳細相關优惠服務 
            <img src="../../images/breakfast1.gif" width="19" height="16">：免費單人早餐 
            <img src="../../images/breakfast2.gif" width="19" height="16">：免費雙人早餐<img src="../chinese/images/space.gif" width="1" height="1"></td>
        </tr>
      </table>
      <table width="598" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFBC04" align="center">
        <tr align="center"> 
          <td> 
            <table width="600" border="0">
 		    ...
 		    <% if (pageno !=1){%>                 
                  ...
                  <td>第 
                    <input type="text" name="pageNo" size="2">
                    頁 <a href="javascript:Search2();"><b><i><font face="Arial, Helvetica, sans-serif" color="#666666">GO</font></i></b></a></td>
                  <td width="50" align="center">第<%=pageno%>頁</td>
                  <td width="50" align="center">共<font color="#FF0000"><%=total_page%></font>頁</td>
                </tr>
              </form>
