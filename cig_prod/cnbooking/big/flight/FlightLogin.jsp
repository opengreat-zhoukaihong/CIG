...
function Search_check()
{
		...
		{
			window.alert("您選擇的出發地點与目的地相同, 請重新選擇 !");
			document.searchForm.homecity.focus();
			return;
		}
...
<!--//
	function DateSubmit_Check()
	{
		...
		{
				window.alert("對不起, "+document.searchForm.d_Year.options[document.searchForm.d_Year.selectedIndex].value+"-"+document.searchForm.d_Month.options[document.searchForm.d_Month.selectedIndex].value+"-"+document.searchForm.d_Day.options[document.searchForm.d_Day.selectedIndex].value+" 這一天不存在, 請檢查出發日期 !");
				document.searchForm.homecity.focus();
		...
		{
			window.alert("對不起, "+document.searchForm.a_Year.options[document.searchForm.a_Year.selectedIndex].value+"-"+document.searchForm.a_Month.options[document.searchForm.a_Month.selectedIndex].value+"-"+document.searchForm.a_Day.options[document.searchForm.a_Day.selectedIndex].value+" 這一天不存在, 請檢查返回日期 !");
			document.searchForm.homecity.focus();
		...
		{
			window.alert("請注意, 返回日期不可能小于出發日期 !");
			document.searchForm.homecity.focus();
			document.searchForm.a_Day.focus();
			return false;
		} 
    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;航線搜索</font><!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
      ...
      <input type=hidden name=curDate value=<%=nowDate%>>
        <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr align="center"> 
            <td height="60"> 
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font color="#000000">航班搜索</font></b></font></span></td>
                </tr>
                <tr align="center"> 
              ...
              <table width="380" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFBC04" align="center">
                <tr valign="middle" align="center"> 
                  <td width="340">
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出發地點：</font></td>
                            </tr>
                          </table>
                        </td>
	                ...
	                <OPTION VALUE="none">請選擇出發的城市</OPTION>
	                <option value=none>--------------</option>
                        <%for(int i=0;i<cityCount;i++){ %>
	                <OPTION VALUE="<%=Convert.g2b(cityList[i][0])%>"><%=Convert.g2b(cityList[i][1])%></OPTION>
	                <%}%>
                        </select>
                        </td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出票地點：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="240"> 
                        ...
                        <OPTION VALUE="none">請選擇出票地點</OPTION>
	                <option value=none>--------------</option>
                        <%for(int i=0;i<cityCount;i++){ %>
	                <OPTION VALUE="<%=Convert.g2b(cityList[i][0])%>"><%=Convert.g2b(cityList[i][1])%></OPTION>
	                <%}%>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">到達地點：</font></td>
                            </tr>
                          </table>
                        </td>
                        <%
		          ...
		          <OPTION VALUE="none">請選擇目的地城市</OPTION>
		          <option value=none>--------------</option>
                          <%for(int i=0;i<cityCount;i++){ %>
	                  <OPTION VALUE="<%=Convert.g2b(cityList[i][0])%>"><%=Convert.g2b(cityList[i][1])%></OPTION>
	                  <%}%>
                      ...
                      <tr> 
                        <td height="30" width="140"> 
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">出發日期：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="240"> 
                  ...
                  name=d_Year>
                    ...
                    value=2001>2001</option>
                          ...
                          年 
                          <SELECT NAME=d_Month SIZE=1 Class=Small><%for(int i=1;i<13;i++){%><OPTION VALUE="<%=i%>" <%if(nowMonth==i){%>selected<%}%> ><%=i%></OPTION><%}%></select>月
                          <SELECT NAME=d_Day SIZE=1 Class=Small><%for(int i=1;i<32;i++){%><OPTION VALUE="<%=i%>" <%if(nowDay==i){%>selected<%}%> ><%=i%></OPTION><%}%></select>日</td>
                      </tr>
                      <tr> 
                        <td height="30" width="140"> 
                        <input name=aDateChoice type=hidden value=Point><input name=aDatePeriod1 type=hidden>
                          <table width="120" border="1" cellspacing="0" cellpadding="2" bordercolor="#CFC8CF" align="center">
                            <tr align="center"> 
                              <td><font color="#000000">航空公司：</font></td>
                            </tr>
                          </table>
                        </td>
                        <td height="30" width="240"> 
                        ...
                        <select class=Small size=1 
                          name=airlineChoice >
                        <OPTION VALUE="0">請選擇航空公司</OPTION>
	                <option value="0">都可以</option>
                        <%for(int i=0;i<airlineCount;i++){ %>
	                <OPTION VALUE="<%=Convert.g2b(airlineList[i][0])%>"><%=Convert.g2b(airlineList[i][1])%></OPTION>
	                <%}%>
                        </select>
                        </td>
                      </tr>
          ...
          <tr align="center"> 
            <td class="txt"><a href="javascript:Search_check();"><img src="/images/big/search.gif" width="138" height="18" border="0"></a></td>
          </tr>
          <tr align="center"> 
            <td class="txt">&nbsp;</td>
          </tr>
          <tr align="center"> 
            <td class="txt"><a href="javascript:window.history.go(-1)">返回</a></td>
          </tr>
        </table>
      </form>
      <!-- #EndEditable --></td>
