    ...
    <td width="664" height="34"> 
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr> 
          ...
          <td width="200" background="/images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" -->==&gt;&gt;航班搜索結果<!-- #EndEditable --></td>
    ...
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> 
     <form name="flightListForm" method="post" action="FlightDestine.jsp">
          ...
          <tr align="center"> 
            <td height="60"> <br>
              ...
              <table width=200 border=0 cellpadding=0 cellspacing=0 bgcolor=#FFBC04 align="center">
                ...
                <tr align="center"> 
                  <td><span class="bigtxt"><font color="#666666" class="bigtxt"><b><font color="#000000">出發航班</font></b></font></span></td>
                </tr>
                <tr align="center"> 
                  <td bgcolor="#CFC8CF" height="3"><img src="/images/space.gif" width="1" height="3"></td>
                </tr>
          ...
          <tr align="center"> 
            <td class="txt">&nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  <td> 
                    <table width="640" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="center" valign="middle"> 
                        <td width="30">預訂</td>
                        <td width="64">航班號</td>
                        <td height="20" width="64">起飛時間</td>
                        <td height="20" width="64">到達時間</td>
                        <td height="20" width="64">起飛机場</td>
                        <td height="20" width="64">到達机場</td>
                        <td height="20" width="64">航空公司</td>
                        <td height="20" width="64">机型</td>
                        <td height="20" width="64">艙位等級</td>
                        <td height="20" width="64">定价</td>
                        <td height="20" width="64">現价</td>
                        <td height="20" width="64">經停</td>
                      </tr>
                      <tr bgcolor="#FFBC04"> 
              ...
              <%
                        ...
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][10].equals("E")){%>經濟艙<%}%><%if(flightLists[i][10].equals("F")){%>頭等艙<%}%><%if(flightLists[i][10].equals("B")){%>公務艙<%}%></div>
                        </td>
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][7]!=null){%><%=Convert.g2b(flightLists[i][7])%><%=Convert.g2b(flightLists[i][9])%><%}else{%>請電<%}%></div>
                        </td>
                        <td height="30"> 
                          <div align="center"><%if(flightLists[i][8]!=null){%><%=Convert.g2b(flightLists[i][8])%><%=Convert.g2b(flightLists[i][9])%><%}else{%>請電<%}%></div>
                        </td>
        ...
        <tr align="center">
          ...
          <tr align="center"> 
            <td class="txt"><font color="#FF0000"><b>目前還沒有可預定的此航線，請再做選擇！</b></font></td>
          </tr>
          <tr align="center"> 
            <td class="txt">&nbsp;</td>
          </tr>
                    ...
                    <table width="640" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <%
              	     ...
              	     for (int i=0;i<maxNum;i++){
                        ...
                        <td height="30"> 
                          <div align="center"><%if(flightLists1[i][10].equals("E")){%>經濟艙<%}%><%if(flightLists1[i][10].equals("F")){%>頭等艙<%}%><%if(flightLists1[i][10].equals("B")){%>公務艙<%}%></div>
                        </td>
                        <td height="30"> 
...
function checkdata(sWay)
	{
		if (document.flightListForm.flight_ID.value.length == 0) {
			window.alert("請确定出發的航班!!");
			return;
		  }
		if (sWay=="R" && document.flightListForm.flight_ID_A.value.length == 0) {
			window.alert("請确定返程航班!!如果您不想預訂返程航班，請在前頁選擇單程選項!!");
			return;
        	  }	
