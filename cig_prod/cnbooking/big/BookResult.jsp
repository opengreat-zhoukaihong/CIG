    ...
    <td width="664" height="34">
      <table width="664" border="0" cellspacing="0" cellpadding="0" height="34">
        <tr>
          ...
          <td width="200" background="../../images/top_back.gif" height="34" valign="bottom"><!-- #BeginEditable "top" --><font color="#666666">==&gt;&gt;預訂訂單</font><!-- #EndEditable --></td>
  ...
  <tr> 
    <td colspan="3" valign="top"><!-- #BeginEditable "main" --> <br>
      <table width="420" border="1" cellspacing="0" bordercolor="#FFBC04" cellpadding="2" align="center">
        <tr align="center"> 
          <td class="txt"><span class="bigtxt"><font color="#666666">謝謝您！</font></span><font color="#666666"><br>
            您的訂單已被接受，訂單號是</font> <b><font color="#000000"><%=bookId%></font></b>，<br>
            <font color="#666666">我們將在最快的時間內确認您的定房！<br>
            您可以通過网站聯系電話隨時查詢您的訂房信息。</font></td>
        </tr>
      </table>
      <div align="center"><br>
