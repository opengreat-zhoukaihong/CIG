    ...
    <td colspan=3 rowspan=3 background="/images/background1_05.gif"> 
      <blockquote> 
        <p><span class="orange-title1">OPERATOR ACCOUNT:</span><span class="dalei"> 
          <!-- #BeginEditable "subtitle" -->The result of &quot;Modify 
          Operator Passwd&quot;<!-- #EndEditable --></span></p>
      </blockquote>
    </td>
...
<table width="753">
  <tr> 
    ...
    <td width="566" height="235" valign="top"><!-- #BeginEditable "mainbody" --> 
      <% if(operator.passwdReset((String)session.getAttribute("operator"),request.getParameter("oldpwd"),request.getParameter("passwd")))
	{ %> 
      <p align="center"> </p>
      <p align="center"> </p>
      <p align="center"><span class="contact"><b> Congradulations!!</b></span></p>
      <p align="center"><span class="contact"><b> You have successfully modified 
        your passwd.</b></span></p>
      <span class="contact"><b><%	} 
	else
	{ %> </b> </span>
      <p align="center"> </p>
      <p align="center"> </p>
      <p align="center"><span class="contact"><b> Sorry!!</b></span></p>
      <p align="center"><span class="contact"><b> Your old password is wrong.</b></span></p>
      <%	}	%> <!-- #EndEditable --></td>
  </tr>
</table>
<br>
