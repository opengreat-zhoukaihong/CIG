...
<table width=758 border=0 cellpadding=0 cellspacing=0>
  ...
  <tr> 
    <td colspan=3 rowspan=3 background="/images/background1_05.gif"> 
      <blockquote> 
        <p><span class="orange-title1">MY ACCOUNT</span>:<span class="dalei"><!-- #BeginEditable "subtitle" -->The result of &quot;Modify 
          my password information&quot;<!-- #EndEditable --></span></p>
      </blockquote>
      </td> 
...
<table width="753" border="0">
  <tr> 
	...
	<% if(login.getUserInfo((String)session.getAttribute("userid")," and Passwd='"+request.getParameter("oldpwd")+"'"))
		{%>	
			<jsp:setProperty name="login" property="*"/>
	<% 		login.modifyUserPasswd();%> 
	      <p class="contact">&nbsp;</p>
	      <p class="contact" align="center">&nbsp; </p>
    	  <p class="contact" align="center"><b>Congradualations!! <br>U have modified your passwd info!!</b><br>
	<% 	} 
		else
		{ %>
	      <p class="contact">&nbsp;</p>
	      <p class="contact" align="center">&nbsp; </p>
	      <p class="contact" align="center"><b>Sorry, Your Old Password is wrong!</b></p>
<%		} %>
<!-- #EndEditable --></td>
  </tr>
</table>
