<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"> <%@ page language="java" errorPage="error.jsp"%> 
<jsp:useBean id="login" scope="request" class="com.forbrand.member.LoginBean"/> 
<jsp:setProperty name="login" property="*"/> 
<jsp:useBean id="email" scope="page" class="com.forbrand.member.email"/>
...
<table width=758 border=0 cellpadding=0 cellspacing=0>
  ...
  <tr> <!-- #BeginEditable "replace" --> 
    <td colspan=3 rowspan=3 background="../../html/images/background1_05.gif"> 
      <blockquote> 
        <p><span class="orange-title1">MY ACCOUNT:</span> <span class="dalei">YOUR 
          REQUEST HAS BEEN ACCESSED!</span></p>
      </blockquote>
    </td>
    <!-- #EndEditable --> 
...
<table width="666" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td valign="top"> <%! String subject,content; %>
<% if(login.isNewUser(request.getParameter("login")))
	{	login.insertNewUser();
		subject = "Thank you for registing Forbrand!";
		content = "<html><body>It is a sample!<br>";
		content += "Your account:"+login.getLogin()+"<br>";
		content += "Your passwd:"+login.getPasswd()+"<br>";
		content += "If you have any question, please contact <a href='mailto:sales@forbrand.com'>sales@forbrand.com</a></body></html>";
		email.sendmail("202.96.140.7","sales@forbrand.com",login.getEmail(),subject,content,"text/html");
%>
      <p class="contact">&nbsp;</p>
      <p class="contact">&nbsp;</p>
      <p class="contact">Thank you for registering with FORBRAND.COM.</p>
      <% } else { %> 
      <p class="contact">Sorry, the login name have already used by another user. 
      </p>
      <p class="contact">please reselect a login name!</p>
      <p class="contact">Click <a href="regform.jsp">here</a> to retry.</p>
      <p class="contact">or</p>
      <% } %> 
      <p class="contact">Click <a href="../index.jsp">here</a> to go to home page. </p>
    </td>
  </tr>
</table>
<p>&nbsp;</p>
