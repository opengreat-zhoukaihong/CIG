        ...
        <tr>
          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="orderCond" method="post" action="searchOrdersRes_eoa.jsp" onSubmit="return validateForm(orderCond)">
                <tr bgcolor="#F4FCFF"> 
                  <td height="30" colspan="2" align="center">请输入查询条件 </td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#DFEEFF" height="29" width="129">订单状态：</td>
                  <td bgcolor="#DFEEFF" height="29" width="359"> 
                    <select name="status" >
                      <option value="1">新订单</option>
                      <option value="100">超期新订单</option>
                      <option value="2">已收订单</option>
                      <option value="3">已确认订单</option>
                      <option value="4">部分发货订单</option>
                      <option value="5">已完成订单</option>
                      <option value="7">取消的订单</option>
                      <option value="8">延期的订单</option>
                      <option value="0">违约订单</option>
                    </select>
                </tr>
                <tr> 
                  <td align="right" bgcolor="#F4FCFF" width="129">供应商名称：</td>
                  <td bgcolor="#F4FCFF" height="30" width="359">
                    <input type="text" name="supplierName" size="15" class="font1">
                  </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" height="30" width="129">经销商名称：</td>
                  <td bgcolor="#DFEEFF" height="30" width="359"> 
                    <input type="text" name="dealerName" size="15" class="font1">
                  </td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#F4FCFF" height="30" width="129">起始订单日期：</td>
                  <td bgcolor="#F4FCFF" height="30" width="359"> 
                    <p> 
                      <input type="text" name="orderDateBgn" size="15" class="font1">
                      <font color="#CC0000">(输入格式:YYYY-MM-DD)</font> </p>
                  </td>
                </tr>
                <tr> 
                  <td align="right" bgcolor="#DFEEFF" height="29" width="129"> 
                    <div align="right">截止订单日期：</div>
                  </td>
                  <td bgcolor="#DFEEFF" height="29" width="359"> 
                    <input type="text" name="orderDateEnd" size="15" class="font1">
                    <font color="#CC0000">(输入格式:YYYY-MM-DD)</font> </td>
                </tr>
                <tr> 
                  <td height="30" align="center" bgcolor="#F4FCFF" width="129"> 
                    <div align="right">订单流水号：</div>
                  </td>
                ...
                <tr bgcolor="#F4FCFF" valign="top"> 
                  <td colspan="2" align="center"> 
                    <div align="left"> 
                      <blockquote> 
                        <div align="left"> 
                          <p><font color="#CC0000">说明</font>:起始订单日期用于查询在该日期以后产生的订单;</p>
                        </div>
                        <blockquote> 
                          <div align="left">截止订单日期用于查询在该日期之前产生的订单;</div>
                        </blockquote>
                      </blockquote>
                    </div>
                  </td>
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td colspan="2" align="center"> 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="searchOrders_eoa.jsp"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" width="80" height="17" border="0"></a> 
                  </td>
                </tr>
                <tr bgcolor="#F4FCFF"> 
                  <td colspan="2">&nbsp;</td>
