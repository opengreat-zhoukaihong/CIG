        ...
        <tr>
          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="orderCond" method="post" action="searchOrdersRes_supp.jsp" onSubmit="return validateForm(orderCond)">
                <tr bgcolor="#DFEEFF"> 
                  <td height="30" colspan="2" align="center">请输入查询条件 </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#F4FCFF" height="29" width="129">订单状态：</td>
                ...
                <tr>
                  <td align="right" bgcolor="#DFEEFF" width="129">公司名称：</td>
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td colspan="2" align="center"> 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="searchOrders_supp.jsp"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" border="0"></a> 
                  </td>
                </tr>
                <tr bgcolor="#F4FCFF"> 
                  <td colspan="2">&nbsp;</td>
