...
<%!
  String lang_code="GB";
  String tempSqlStr;
  String shipID,memberID,countryID,provinceID,cityID;
  String zipCode,telephone,fax,contEmail;
  String shipName,address,contName;
  int errorCode;
%>

<jsp:useBean id="modifyShip" scope="page" class="com.cig.chinaeoa.member.ShipManager" />
...
<%
        ...
        shipName = request.getParameter("shipName").trim();
        ...
        tempSqlStr = "update shipment set countryID = '" + countryID +
          "',provinceID = '" + provinceID + "',cityID = '" + cityID +
          "',zipCode = '" + zipCode + "',tel = '" + telephone +
          "',fax = '" + fax + "',email = '" + contEmail +
          "',md_date = sysdate where shipID = '" + shipID + "'";

        modifyShip.setSqlStr(tempSqlStr);

        tempSqlStr = "update shipment_L set shipName = '" + shipName +
          "',contName_F = '" + contName + "',address1 = '" + address +
          "' where shipID = '" + shipID + "' and lang_code = '" + lang_code + "'";

        modifyShip.setSqlStr2(tempSqlStr);

        modifyShip.modifyShip();
        errorCode = modifyShip.getErrorCode();
        if(errorCode==0)
        {
%>
            <p>操作成功!</p>
            <p><a href="shipList.jsp?action=modify">返回</a></p>
