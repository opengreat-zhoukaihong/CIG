                    ...
                    if (rs != null) 
                    {
                      while (rs.next())
                      {
                       %>
                        ...
                        <td height="25" class="font3b"> <a href="BrandList.jsp?LangCode=<%=LangCode%>&TypeId=3&BrandId=<%=rs.getString("BrandId")%>">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="460">
                          <tr> 
                            ...
                            <td align="right" height="20" width="233"><img src="/images/temp/car.gif" width="19" height="16" align="absbottom"> 
                              <a href="#" onClick="openorder('orderlist.htm')">查看购物车</a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
