          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="orderCond" method="post" action="searchOrdersRes_dealer.jsp" onSubmit="return validateForm(orderCond)">
                ...
                <tr>
                  <td align="right" bgcolor="#DFEEFF" width="129">供应商名称：</td>
                ...
                <tr bgcolor="#DFEEFF"> 
                  <td colspan="2" align="center"> 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="searchOrders_dealer.jsp"><img src="/images/temp/reset.gif" name="cancel" value="取   消" class="font1" border="0"></a> 
                  </td>
                </tr>
                <tr bgcolor="#F4FCFF">
                  <td colspan="2">&nbsp;</td>
