...
<%
    ...
    tempSqlStr = "select m.question,m.answer from member m,users u " +
      " where u.userID = '" + userID + "' and u.USERLEVEL = '" +
      highLevel + "' and u.memberID = m.memberID ";
    
    memberManager.setSqlStr(tempSqlStr);
    questionInfo = memberManager.getTempDatas();
    if(questionInfo != null)
    {
      if(questionInfo.next())
      {
        question = questionInfo.getString("question");
        answer = questionInfo.getString("answer");
%>

              <form name="rpass" method="post" action="rpass3.jsp" >
                <tr bgcolor="#F4FCFF">
                  <td height="30" colspan="2" align="center"><font color="#CC0000">请根据密码提示,输入您的答案:</font></td>
                </tr>
                <tr bgcolor="#DFEEFF">
                ...
                <tr bgcolor="#DFEEFF">
                  ...
                  <td bgcolor="#DFEEFF">
                    <input type="text" name="inputAnswer" size="15" class="font1">
