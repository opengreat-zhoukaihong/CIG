...
<%
        ...
        tempSqlStr = "delete delivery_L where deliveryID='" + deliveryID + "' and lang_code = '" +
          lang_code + "'";

        modifyDelivery.setSqlStr(tempSqlStr);

        tempSqlStr = "delete delivery where deliveryID ='" + deliveryID + "'";
...
%>
            <p>操作成功!</p>
            <p><a href="deliveryList.jsp?action=delete">返回</a></p>
