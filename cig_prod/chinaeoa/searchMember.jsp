<%@ page import="java.util.*,java.io.*" session="true" language="java" errorPage="error.jsp"%>
        ...
        <tr>
          ...
          <td>
            ...
            <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
              <form name="membCond" method="post" action="searchMembResult.jsp" onSubmit="return validateForm(membCond)">
                <tr bgcolor="#F4FCFF"> 
                  <td height="30" colspan="2" align="center">请输入查询条件 </td>
                </tr>
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#DFEEFF" height="27">会员类别：</td>
                  <td bgcolor="#DFEEFF" height="27"> 
                ...
                <tr bgcolor="#DFEEFF">
                  <td align="right" bgcolor="#F4FCFF" height="27">会员状态：</td>
                  <td bgcolor="#F4FCFF" height="27"> 
                    <select name="status" >
                        <option value="A">正式会员</option>
                        <option value="D">未获批准者</option>
                    </select>
                </tr>
                <tr> 
                  <td align="right" bgcolor="#DFEEFF" height="26">公司名称：</td>
                  <td bgcolor="#DFEEFF" height="26"> 
                    <input type="text" name="name" size="15" class="font1">
                  </td>
                </tr>
                <tr bgcolor="#DFEEFF"> 
                  <td align="right" bgcolor="#F4FCFF">注册日期：</td>
                  <td bgcolor="#F4FCFF"> 
