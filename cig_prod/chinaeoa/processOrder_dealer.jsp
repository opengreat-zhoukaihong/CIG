...
<%!
  ...
  String status,orderID,buyerID;
  String statusName,paymentMethod,paymentID;
  String searchOrderID,sellerName,orderDateBgn,orderDateEnd;
  int pageNo;
        ...
        <tr valign="top">
          <td>
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <form name="orderProcess" action="processOrder2_dealer.jsp" method="post">
...
<%
        if(status.equals("5")) {
%> <a href="javascript:completed()"> <b>货已收到</b>&nbsp; </a>
<%      } %>
               </td>
              </tr>
              <tr>
