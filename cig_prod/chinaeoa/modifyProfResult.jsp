...
<%
        ...
        tempSqlStr = "update member set countryID='" + country + "',provinceID = '" + province +
          "',cityID='" + city + "',zipCode='" + zipCode + "',tel='" + telephone +
          "',fax='" + fax + "',compSize='" + compSize + "',compType='"+ compType +
          "',account='" + bankAccount + "',taxAccount = '" + taxAccount +
          "',contSex='" + contSex + "',contEmail='" + contEmail +
          "',question='" + question + "',answer='" + answer +
          "',md_date = sysdate where memberID = '" + memberID + "'";

        modifyProf.setSqlStr(tempSqlStr);

        tempSqlStr = "update member_L set compName = '" + compName +
          "',address1 = '" + compAddr + "',lawRep_F = '" + lawRep +
          "',bank='" + bank + "',contName_F='" + contName +
          "',contDept = '" + contDept + "',contTitle = '" + contTitle +
          "' where memberID = '" + memberID + "' and lang_code = '" + lang_code + "'";

        modifyProf.setSqlStr2(tempSqlStr);

        modifyProf.updateProfile();
        errorCode = modifyProf.getErrorCode();
        if(errorCode==0)
        {
%>
            <p>操作成功!</p>
