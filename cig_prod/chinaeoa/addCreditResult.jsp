...
<%!
    ...
    String memberID,supplierID,creditAmount,pay_term,compName;
    String tempSqlStr;
    int errorCode;
%>
...
<%
        ...
        creditAmount = request.getParameter("creditAmount");
        if(("").equals(creditAmount))
          creditAmount = "0";
        pay_term = request.getParameter("pay_term");
        if(("").equals(pay_term))
          pay_term = "0";

        if((memberID == null) || (supplierID == null))
        {
%>
            <p>很抱歉!系统有误!</p>
...
%>
            ...
            <p>很抱歉!该用户的信用度已设置过了！</p>
            <p>如要修改该用户的信用度,请选择菜单中的修改信用额度!</p>
            <p><a href="javascript:history.go(-1);">返回</a></p>
<%
          }
          else
          {
            ...
            tempSqlStr = "insert into payment (memberID,supplierID,creditAmount, " +
              " pay_term,amountUsed, cr_date,md_date) values ('" + memberID + "','" + supplierID +
              "','" + creditAmount + "','" + pay_term + "','0',sysdate,sysdate )";
